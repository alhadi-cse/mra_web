                ...
                <?php if (empty($org_id)) { ?>
                    <tr>        
                        <td style="text-align:justify;">
                            <?php
                            echo $this->Form->create('CDBNonMfiCoveredDistrict');
                            ?>
                    ...
                    <td>
                        <div id="searching">                                                       
                            <table class="view" style="width:780px; font-family:verdana, helvetica, arial;">
                                <tr>
                                    <th style="width:230px;"><?php echo $this->Paginator->sort('CDBNonMfiBasicInfo.name_of_org', 'Name of Organization') ?></th>
                                    <th style="width:120px;"><?php echo $this->Paginator->sort('CDBNonMfiBasicInfo.registration_no', 'Registration No') ?></th>
                                ...
                                <?php foreach ($values as $value) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $value['CDBNonMfiBasicInfo']['registration_no']; ?></td>
        ...
        <div class="btns-div">                
            <table style="margin:0 auto; padding:0;" cellspacing="7">
                <tr>
                    <td></td>
                    <td></td>
                    <td><?php if (empty($org_id)) echo $this->Js->link('Add New', array('controller' => 'CDBNonMfiBasicInfos', 'action' => 'add'), array_merge($pageLoading, array('class' => 'mybtns'))); ?></td>
                    <td></td>
                    <td></td>   
                </tr>
            </table>
