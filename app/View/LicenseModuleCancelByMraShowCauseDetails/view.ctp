...
$title = "Show cause for Cancellation";
...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <fieldset>
                <legend>Show cause Sent</legend>

                <?php
                if (empty($org_id)) {
                    echo $this->Form->create('LicenseModuleCancelByMraShowCauseDetailCompleted');
                    ?>
                    <table cellpadding="0" cellspacing="0" border="0">                           
                        <tr>
                            ...
                            <td style="text-align:left;">
                                <?php echo $this->Js->submit('Search', array_merge($pageLoading, array('id' => 'search_completed', 'class' => 'btnsearch'))); ?>
                            </td>                                
                        </tr>
                    </table>
                    <?php
                            ...
                            <?php foreach ($completed_values as $value) { ?>                
                                <tr>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        ...
                                        if ($current_state == $thisStateIds[1]) {
                                            echo "<p style='background-color:#037108;color:#fff;'>Show cause sent for License Cancellation</p>";
                                        } else {
                                            echo "<p style='background-color:#713002;color:#fff;'>Not yet sent any show cause</p>";
                                        }
                                        ?>
                                    </td>
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php
                                        echo $this->Js->link('Details', array('controller' => 'LicenseModuleCancelByMraShowCauseDetails', 'action' => 'preview', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                                        ?>
                                    </td>
                                </tr>
                            <?php } ?>
            ...
            <fieldset>
                <legend>Show cause Pending</legend>
                <?php
                if (empty($pending_values) || !is_array($pending_values) || count($pending_values) < 1) {
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleCancelByMraShowCauseDetailPending');
                        ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                                ...
                                <td style="padding-right:5px"><?php echo $this->Js->submit('Search', array_merge($pageLoading, array('id' => 'search_pending', 'class' => 'btnsearch'))); ?></td>
                                <td>
                                    <?php
                                    if (!empty($opt_all) && $opt_all) {
                                        echo $this->Js->link('View All', array('controller' => 'LicenseModuleCancelByMraShowCauseDetails', 'action' => 'view', 'all'), array_merge($pageLoading, array('class' => 'mybtns sbtns')));
                                    }
                                    ?>
                                </td>
                            </tr>
                        ...
                        <table class="view">
                            ...
                            <?php foreach ($pending_values as $value) { ?>                
                                <tr>
                                    ...
                                    <?php
                                    $actions = $this->Js->link('Details', array('controller' => 'BasicModuleBasicInformations', 'action' => 'preview', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));

                                    if ($thisStateIds[0] == $value['BasicModuleBasicInformation']['licensing_state_id']) {
                                        $width = '187px';
                                        $actions = $actions . $this->Js->link('Send Notification', array('controller' => 'LicenseModuleCancelByMraShowCauseDetails', 'action' => 'show_cause_for_cancellation', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                                    } else {
                                        $width = '50px';
                                    }
                                    ?>
