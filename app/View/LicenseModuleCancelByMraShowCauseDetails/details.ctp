    ...
    <fieldset>        
        <div class="datagrid" style="max-height:430px; overflow-y:auto; color:#232428;">
            <table cellpadding="7" cellspacing="8" border="0">              
                ...
                <tr>
                    <td>Show cause Date</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleCancelByMraShowCauseDetail']['show_cause_date']; ?></td>
                </tr>
                <tr>
                    <td>Show cause Reason</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleCancelByMraShowCauseDetail']['show_cause_reasons']; ?></td>
                </tr>
            </table>
        </div>
    </fieldset>
