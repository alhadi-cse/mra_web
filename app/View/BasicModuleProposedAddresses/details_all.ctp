...
<div id="addDetailsInfo" title="Address Details" style="margin:0px; padding:8px; background-color:#fafdff;">
            ...
            <div id="tabs">
                ...
                <?php 
                    ...
                    foreach($allDataDetails as $addDetails) {
                        $rc++;
                        echo '<li><a href="#tabs-'.$rc.'">'.$addDetails['LookupBasicProposedAddressType']['address_type'].'</a></li>';
                    }
                ?>
                </ul>
