                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            echo $this->Form->input('apply_date', array('type'=>'hidden', 'label'=>false));
                        ?>
                    </td>
                </tr>
                <tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleDirectSuspensionApplicationOfReviewDetails','action' => 'view?this_state_ids='.$this_state_ids),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
