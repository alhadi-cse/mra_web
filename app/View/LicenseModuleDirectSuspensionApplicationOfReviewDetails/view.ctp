...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleDirectSuspensionApplicationOfReviewDetail'); ?>
            ...
            <fieldset>
                <legend>Applied for Review</legend>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        <?php
                                            ...
                                            if($licensing_state_id==$thisStateIds[1]){
                                                echo "<p style='background-color:#037108;color:#fff;'>Review Application Submitted</p>";
                                            }                                            
                                            else{
                                                echo "<p style='background-color:#713002;color:#fff;'>Not yet applied</p>";
                                            }                                            
                                        ?>
                                    </td>
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionApplicationOfReviewDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                <legend>Not Applied/Pending</legend>
                <?php 
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleDirectSuspensionApplicationOfReviewDetailPending');
                    ?>
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionApplicationOfReviewDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id'],1), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     

                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '135px';
                                        $actions = $actions.$this->Js->link('Apply', array('controller'=>'LicenseModuleDirectSuspensionApplicationOfReviewDetails', 'action'=>'apply', $value['BasicModuleBasicInformation']['id']), 
