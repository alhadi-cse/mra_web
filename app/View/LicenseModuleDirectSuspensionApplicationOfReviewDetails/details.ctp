        ...
        <div class="datagrid" style="max-height:430px; overflow-y:auto; color:#232428;">
            <table cellpadding="7" cellspacing="8" border="0">              
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleDirectSuspensionApplicationOfReviewDetail']['apply_date']; ?></td>
                </tr>
                <tr>
                    <td>Review Application Details</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleDirectSuspensionApplicationOfReviewDetail']['review_application_details']; ?></td>
                </tr>
            </table>
        </div>
    </fieldset>
