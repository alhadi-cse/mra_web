...
<fieldset>
    ...
    <div id="data_div" style="width:100%; height:auto; overflow-x:auto;">
        ...
        <fieldset style="margin:0 5px 5px;">
            ...
            <div id="divReport" style="width:auto; height:100%; min-width:500px; min-height:100px; max-height:450px; max-height:45vh; padding:3px 8px 8px 8px; line-height:1.8; overflow:auto;">
                <?php
            ...
            <div id="divReportBtn" style="width:auto; height:auto; margin:0; padding:0;"></div>
        </fieldset>
...
//        'beforeSend' => '$("#busy-indicator").fadeIn();',
//        'complete' => '$("#busy-indicator").fadeOut(); modal_close("report_opt"); modal_open("report_bb_viewer", 0, "Bangladesh Bank Report"); ', //modal.init("Report", "report_view"); modal.init("MF-DBMS Report", "report_bb_viewer"); 'complete' => '$("#busy-indicator").fadeOut(); modal.init("MF-DBMS Report", "report_bb_viewer");',
