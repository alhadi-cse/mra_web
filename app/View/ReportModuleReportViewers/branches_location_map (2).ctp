                        ...
                        <tr>
                            <td colspan="2" style='vertical-align:top; text-align:left; padding:3px 0;'>
                                <fieldset>
                                    ...
                                    echo $this->Form->input('', array('name' => 'bd_info', 'type' => 'radio', 'options' => $bd_admins, 'empty' => 'None', 'escape' => false, 'legend' => false, 'div' => false, 'label' => true));
                                    ?>
                                    <div>
