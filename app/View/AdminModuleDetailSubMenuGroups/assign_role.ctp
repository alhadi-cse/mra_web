    ...
    <fieldset>
        ...
        <div class="form">
            <table cellpadding="6" cellspacing="4" border="0">
                ...
                <tr>
                    <td colspan="3" id="group_lists" style="vertical-align: top;"></td>
                </tr>                
                <tr>
                    <td>Groups Available for Assigning</td>
                    <td class="colons">:</td>
        ...
        <div class="btns-div" id="buttons"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td><?php echo $this->Js->link('Close', array('controller' => 'AdminModuleDetailSubMenuGroups', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns'))); ?> </td>
                    <td style="text-align:center;">
                        <?php
                            echo $this->Js->submit('Assign', array_merge($pageLoading, array('success' => "msg.init('success', '$title', 'User roles has been assigned successfully.');",
...
$this->Js->get('#module_names')->event('change', 
    $this->Js->request(array(
        'controller'=>'AdminModuleDetailSubMenuGroups',
        'action'=>'update_user_group_options'
        ), array(
        'update'=>'#group_names',            
        'async'=>true,
        'method'=>'post',
...
$this->Js->get('#sub_menu_names')->event('change', 
    $this->Js->request(array(
        'controller'=>'AdminModuleDetailSubMenuGroups',
        'action'=>'update_user_group_list'
        ), array(
