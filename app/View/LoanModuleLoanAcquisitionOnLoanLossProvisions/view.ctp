                                ...
                                <td>
                                    <?php 
                                        $options = array('BasicModuleBranchInfo.branch_name'=>'Branch Name',
                                                         'LookupLoanLossProvisioning.loan_loss_provisionings' => 'Loan Provision');
                                ...
                                <td>
                                    <?php 
                                        if(!empty($opt_all) && $opt_all) {
                                            echo $this->Js->link('View All', array('controller'=>'LoanModuleLoanAcquisitionOnLoanLossProvisions', 'action'=>'view', 'all'), 
                        ...
                        <div style="width:780px; height:auto; overflow-x:auto;">
                            ...
                            <table class="view">
                                <tr>
                                    ...
                                    <th style="width:100px;"><?php echo $this->Paginator->sort('LookupLoanLossProvisioning.loan_loss_provisionings','Loan Provision') ?></th>
                                    <th style="width:80px;"><?php echo $this->Paginator->sort('LoanModuleLoanAcquisitionOnLoanLossProvision.year_and_month','Year & Month') ?></th> 
                                    <th style="width:80px;"><?php echo $this->Paginator->sort('LoanModuleLoanAcquisitionOnLoanLossProvision.no_of_borrowers','No. Of Borrowers') ?></th>
                                    <th style="width:80px;"><?php echo $this->Paginator->sort('LoanModuleLoanAcquisitionOnLoanLossProvision.amount_of_loan','Amount Of Loan') ?></th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value['LookupLoanLossProvisioning']['loan_loss_provisionings']; ?></td>
                                    <td style="text-align:center;"><?php echo $this->Time->format($value['LoanModuleLoanAcquisitionOnLoanLossProvision']['year_and_month'], '%B, %Y', ''); ?></td>
                                    <td style="text-align:center;"><?php echo $value['LoanModuleLoanAcquisitionOnLoanLossProvision']['no_of_borrowers']; ?></td>
                                    <td style="text-align:right;"><?php echo $value['LoanModuleLoanAcquisitionOnLoanLossProvision']['amount_of_loan']; ?></td>
                                    <td style="height:30px; padding:2px; text-align:center;">
                                        <?php 
                                            echo $this->Js->link('Edit', array('controller'=>'LoanModuleLoanAcquisitionOnLoanLossProvisions','action'=>'edit', $value['LoanModuleLoanAcquisitionOnLoanLossProvision']['id'], $value['LoanModuleLoanAcquisitionOnLoanLossProvision']['org_id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink')))
                                                .$this->Js->link('Details', array('controller'=>'LoanModuleLoanAcquisitionOnLoanLossProvisions','action'=>'preview', $value['LoanModuleLoanAcquisitionOnLoanLossProvision']['id']), 
...
//                                                    array_merge($pageLoading, array('class'=>'mybtns', 'success'=>'msc.prev();')));
                    ...
                    <td>
                        <?php 
                            echo $this->Js->link('Add New', array('controller'=>'LoanModuleLoanAcquisitionOnLoanLossProvisions','action'=>'add'), 
