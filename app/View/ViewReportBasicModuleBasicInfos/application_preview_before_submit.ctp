...
<div id="basicInfo" title="Preview of Application" style="margin:0; overflow-x:scroll; overflow-y: hidden; padding-bottom:10px; color:#232428; background-color:#fafdff;"> 
    <div style="padding: 2px 0px 2px 0px;">
        <fieldset style="font-size: 14px; font-weight: bold; width: 250px;">        
            <?php echo $title;?>        
        </fieldset>
    </div>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:0;" cellspacing="5">
                <tr>
                    ...
                    <td>
                        <?php                                 
                            echo $this->Js->link('Submit', array('controller'=>'ViewReportBasicModuleBasicInfos', 'action'=>'final_submit'), 
                                                    array_merge($pageLoading, array('success'=>"msg.init('success', '$title', 'License application has been submitted successfully.');", 
                                                                  'error'=>"msg.init('error', '$title', 'License application submission failed!');")));
                        ?>
                    </td>
                    <td></td>
                </tr>
