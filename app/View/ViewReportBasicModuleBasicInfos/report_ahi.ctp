        ...
        <div class="datagrid">
            ...
            <table cellpadding="7" cellspacing="8" border="0">
                <tr>
                    <td>Program Area</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['programArea']; ?></td>
                </tr>
                <tr>
                    <td>Source Of Fund</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['sourceOfFund']; ?></td>
                </tr>
                <tr>
                    <td>Percent Of Share</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['percentOfShare']; ?></td>
                </tr>
                <tr>
                    <td>Share In BDT</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['shareInBDT']; ?></td>
                </tr>
                <tr>
                    <td>CEO Name In Case Of SepLegal Entity</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['ceoNameInCaseOfSepLegalEntity']; ?></td>
                </tr>
                <tr>
                    <td>Address</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['address']; ?></td>
                </tr>
                <tr>
                    <td>Phone</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['phone']; ?></td>
                </tr>
                <tr>
                    <td>Fax</td>
                    <td class="colons">:</td>
                    <td><?php echo $mfiDetails['BasicModuleOtherActivity']['fax']; ?></td>
                </tr>
            </table> 
