...
<div id="basicInfo" title="Preview of Application" style="margin:0; padding:10px; color:#232428; background-color:#fafdff;"> 
...
<?php echo $this->Html->link('Submit', array('controller'=>'ViewReportBasicModuleBasicInfos','action'=>'final_submit'), array('id'=>'lnkSubmit','style'=>'display:none;')); ?>
...
<script>   
    ...
    $(function () {      
        ...
        $( "#basicInfo" ).dialog({
                ...
                buttons: {                 
                    Submit: function() { 
                        window.location=$('#lnkSubmit').attr('href');
                    },
                    Close: function() {
                        $(this).dialog( "close" );
                    }
