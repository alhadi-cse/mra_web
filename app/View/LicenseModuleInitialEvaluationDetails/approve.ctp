...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleInitialEvaluationDetail'); ?>
            ...
            <table style="width:100%;" cellpadding="8" cellspacing="8" border="0">
                <tr>
                    ...
                    <?php 
                        ...
                        echo $this->Js->link('Pre. Details', array('controller'=>'LicenseModuleFieldInspectionDetails','action'=>'preview', $org_id, 1), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block; float:right;', 'update'=>'#popup_div')));
                    ?>
                    </td>
                </tr>
                <tr>
            ...
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    ...
                    <td style="text-align: center;">
                        <?php
                            echo $this->Js->submit('Evaluate', array_merge($pageLoading, 
