                ...
                <tr>
                    ...
                    <td style="padding-left:10px">
                        <?php
                            ...
                            echo $this->Form->input('id', array('type'=>'hidden', 'value'=>$approvalDetails['LicenseModuleInitialEvaluationDetail']['id'], 'label'=>false));
...
//                            echo $this->Form->input('org_id', array('type' => 'hidden', 'value' => $approvalDetails['BasicModuleBasicInformation']['id'], 'label' => false));
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $approvalStatusId = $approvalDetails['LicenseModuleInitialEvaluationDetail']['approval_status_id'];
                ...
                <tr>
                    ...
                    <td style="padding-left:10px">
                        <?php 
                            echo $this->Time->format($approvalDetails['LicenseModuleInitialEvaluationDetail']['approval_date'],'%d-%m-%Y','');
                ...
                <tr id="if_not_approved" <?php if(!empty($approvalStatusId) && $approvalStatusId == 1) echo 'style="display:none;"'; ?>>
                    ...
                    <td style="padding-left:10px">
                        <?php 
                            echo $this->Form->input('reason_if_not_approved',array('type' => 'textarea', 'value'=>$approvalDetails['LicenseModuleInitialEvaluationDetail']['reason_if_not_approved'], 'escape' => false, 'div'=>false,'label' => false)); 
                        ?>
                    </td>
                </tr>
                <tr>
                    <td>Comment</td>
                    <td class="colons">:</td>
                    <td style="padding-left:10px"><?php echo $this->Form->input('comment',array('type' => 'textarea', 'value'=>$approvalDetails['LicenseModuleInitialEvaluationDetail']['comment'], 'escape' => false, 'div'=>false, 'label' => false)); ?></td>
                </tr>
            </table>
        </div>
        <div class="btns-div"> 
