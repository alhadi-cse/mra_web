...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleInitialEvaluationDetail'); ?>
            ...
            <fieldset>
                <legend>Initial Evaluation Completed</legend>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:70px;'>" . $this->Paginator->sort('LicenseModuleInitialEvaluationDetail.approval_date', 'Approval Date') . "</th>";
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->Time->format($value['LicenseModuleInitialEvaluationDetail']['approval_date'], '%d-%m-%Y', ''); ?></td>
                        <td style="text-align:center; padding:2px; height:30px;">
                           <?php 
                                echo $this->Js->link('Re-Approve', array('controller' => 'LicenseModuleInitialEvaluationDetails','action' => 're_approve', $value['LicenseModuleInitialEvaluationDetail']['org_id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink')))
                                    . $this->Js->link('Details', array('controller' => 'LicenseModuleInitialEvaluationDetails','action' => 'preview', $value['LicenseModuleInitialEvaluationDetail']['org_id']), 
            ...
            <fieldset>
                <legend>Initial Evaluation In Progress</legend>
                
                <?php
                if ($values_in_progress == null || !is_array($values_in_progress) || count($values_in_progress) < 1) {
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; padding:2px; height:30px;">
                           <?php 
                                echo $this->Js->link('Approve', array('controller' => 'LicenseModuleInitialEvaluationDetails','action' => 're_approve', $value['LicenseModuleInitialEvaluationDetail']['org_id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink')))
                                    . $this->Js->link('Details', array('controller' => 'LicenseModuleInitialEvaluationDetails','action' => 'preview', $value['LicenseModuleInitialEvaluationDetail']['org_id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink', 'update' => '#popup_div')));
                           ?>     
                ...
                <div class="btns-div" style="padding:7px; text-align:center;">
                    <?php
                        echo $this->Js->link('Approve All', array('controller' => 'LicenseModuleInitialEvaluationDetails','action' => 'approve_edit_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Initial Evaluation Update')));                            
                    ?>
                </div>                
                <?php } ?>
            ...
            <fieldset>
                <legend>Initial Evaluation Pending</legend>
                <?php 
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php 
                                echo $this->Js->link('Evaluate', array('controller'=>'LicenseModuleInitialEvaluationDetails','action'=>'approve', $value['BasicModuleBasicInformation']['id']), 
                                                    array_merge($pageLoading, array('class'=>'btnlink')))
                                    .$this->Js->link('Pre. Details', array('controller' => 'LicenseModuleFieldInspectionDetails','action' => 'preview', $value['BasicModuleBasicInformation']['id'], 1), 
                                                                array_merge($pageLoading, array('class'=>'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
                    </tr>
                ...
                <?php
                    ...
                    if(count($values_not_approved) > 1 ) {
                        echo '<div class="btns-div" style="padding:7px; text-align:center;">'
                                . $this->Js->link('Evaluate All', array('controller' => 'LicenseModuleInitialEvaluationDetails','action' => 'approve_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Initial Assessment Approve All')))
                            . '</div>';
                    }
                }
                ?>
