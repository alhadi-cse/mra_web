...
<div>
    ...
    <fieldset>
        <legend>License Evaluation Verification Approval</legend> 
        <?php echo $this->Form->create('LicenseModuleLicenseEvaluationVerificationApprovalDetail'); ?>
            ...
            <tr>
                <td colspan="3" style="border-bottom:2px solid #137387; padding:0;">
                    <p style="padding:0 0 0 15px;">
                        ...
                        echo $this->Js->link('Pre. Details', array('controller' => 'LicenseModuleFieldInspectionDetails', 'action' => 'preview', $org_id), array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'display:inline-block;', 'update' => '#popup_div')));
                        ?>
                    </p>
                </td>
            </tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    ...
                    <?php  echo $this->Js->link('Close', array('controller' => 'LicenseModuleLicenseEvaluationVerificationDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns'))); ?> 
                    </td>
