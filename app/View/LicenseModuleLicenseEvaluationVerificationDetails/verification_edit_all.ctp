                        ...
                        <table class="view">
                            ...
                            <tr>
                                <td style="display:none;">
                                    <?php 
                                        echo $this->Form->input("$rc.id", array('type'=>'hidden', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationVerificationDetail']['id'], 'label'=>false));    
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($verification_status_options as $value => $text) {
                                            ...
                                            if($value==$orgDetail['LicenseModuleLicenseEvaluationVerificationDetail']['verification_status_id']){ echo 'checked'; }
                                ...
                                <td>
                                    <?php 
                                        echo $this->Time->format($orgDetail['LicenseModuleLicenseEvaluationVerificationDetail']['verification_date'],'%d-%m-%Y','');
                                        echo $this->Form->input("$rc.verification_date", array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                                    ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.reason_if_not_approved",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationVerificationDetail']['reason_if_not_approved'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.verification_comment",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationVerificationDetail']['verification_comment'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
