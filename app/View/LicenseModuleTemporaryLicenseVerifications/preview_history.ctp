        ...
        <div class="datagrid" style="max-height:430px; overflow-y:auto; color:#232428;">            
            <table cellpadding="7" cellspacing="8" border="0">  
                ...
                <tr>
                    ...
                    <td>
                        <?php                      
                            if($allDetails['LicenseModuleTemporaryLicenseVerification']['verification_status_id']=='1'){
                                echo 'Verified';
                            }
                            else{
                                echo 'Pending';
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleTemporaryLicenseVerification']['verification_date']; ?></td>
                </tr>                
                <tr>
                    <td>Comments</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleTemporaryLicenseVerification']['comments']; ?></td>
                </tr>
            </table>
        </div>
    </fieldset>
