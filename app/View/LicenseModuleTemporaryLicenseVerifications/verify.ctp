...
<div>
    <fieldset>
        ...
        <?php 
            echo $this->Form->create('LicenseModuleTemporaryLicenseVerification');
        ?>
        ...
        <div class="btns-div">
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleTemporaryLicenseVerifications','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));
                        ?>
                    </td>
