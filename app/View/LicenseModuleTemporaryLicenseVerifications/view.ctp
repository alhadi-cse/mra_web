<?php
    $title = 'Temporary License Verification';   
                                    ...
                                    <table class="view">
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align:center; padding:2px; height:30px;">
                                               <?php 
                                                    echo $this->Js->link('Details', array('controller' => 'LicenseModuleTemporaryLicenseVerifications', 'action' => '', $value['BasicModuleBasicInformation']['id']), 
                                ...
                                <table class="view">                            
                                    ...
                                    <tr>                                
                                        ...
                                        <td style="height:30px; padding:2px; text-align:center;">
                                            <?php
                                                echo $this->Js->link('Details', array('controller'=>'LicenseModuleTemporaryLicenseVerifications', 'action'=>'preview_history', $value['user_id'],$value['org_id']), 
                                                        array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                       
                                            ?>
                                        </td>
                                    </tr> 
                                ...
                                ?>
                                        <table class="view">
                                            ...
                                            <tr>
                                                ...
                                                <td style="height:30px; padding:2px; text-align:center;">
                                                    <?php                                                       
                                                        echo $this->Js->link('Review/Verify', array('controller'=>'LicenseModuleTemporaryLicenseVerifications', 'action'=>'verify', $value['BasicModuleBasicInformation']['id'],$thisStateIds[1]), 
                                                                array_merge($pageLoading, array('class'=>'btnlink')))
                                                            .$this->Js->link('Details', array('controller'=>'LicenseModuleTemporaryLicenseVerifications', 'action'=>'preview_pending', $value['BasicModuleBasicInformation']['id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));
