...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleCancelByMraCancelOrRevokeShowCauseDetailAll'); ?>
                    ...
                    <div style="width:780px; height:auto; padding:0; overflow-x:auto;">
                        <?php 
                            if($orgDetails==null || !is_array($orgDetails) || count($orgDetails)<1) {
                                ...
                                echo $this->Js->link('Back', array('controller' => 'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));
                            }
                            else {
                        ?>
                        ...
                        <table class="view">
                            <tr>
                                ...
                                if(!$this->Paginator->param('options'))
                                    echo "<th style='width:75px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.form_serial_no', 'Form Serial No.', array('class'=>'asc')) . "</th>";
                                else 
                                    echo "<th style='width:75px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.form_serial_no', 'Form Serial No.') . "</th>";
                            ...
                            <tr>
                                <td style="text-align:center;">
                                    <?php 
                                        ...
                                        echo $this->Form->input("$rc.id", array('type'=>'hidden', 'value'=>$orgDetail['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['id'], 'label'=>false));    
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($approval_status_options as $value => $text) {
                                            echo "<input type='radio' style='margin:2px;' name='data[LicenseModuleCancelByMraCancelOrRevokeShowCauseDetailAll][$rc][showcause_cancel_status_id]' ";
                                            if($value==$orgDetail['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['showcause_cancel_status_id']){ echo 'checked'; }
                                ...
                                <td>
                                    <?php 
                                        echo $this->Time->format($orgDetail['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['showcause_cancel_date'],'%d-%m-%Y','');
                                        echo $this->Form->input("$rc.showcause_cancel_date", array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                                    ?>
                                </td>                               
                                <td>
                                    <?php echo $this->Form->input("$rc.comment",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['comment'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td style="height:30px; padding:2px; text-align:center;"> 
                                    <?php 
                                        echo $this->Js->link('Details', array('controller' => 'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails','action' => 'preview', $orgDetail['BasicModuleBasicInformation']['id']), 
