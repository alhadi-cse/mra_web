...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail'); ?>
            ...
            <table style="width:100%;" cellpadding="8" cellspacing="8" border="0">
                <tr>
                    ...
                    <?php 
                        ...
                        echo $this->Js->link('Pre. Details', array('controller'=>'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails','action'=>'preview', $org_id), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block; float:right;', 'update'=>'#popup_div')));
                    ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td>
                        <?php echo $this->Form->input("showcause_cancel_status_id", array('type' => 'radio', 'class' => 'approval_status', 'options' => $approval_status_options, 'legend' => false, 'div' => false)); ?>
                    </td>
                </tr>
                <tr>
