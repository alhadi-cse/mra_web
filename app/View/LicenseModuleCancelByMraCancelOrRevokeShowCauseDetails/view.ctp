            ...
            <fieldset>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:70px;'>" . $this->Paginator->sort('LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail.showcause_cancel_date', 'Date') . "</th>";
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <?php 
                            if($value['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['showcause_cancel_status_id']=='0'){
                                echo 'License Cancelled';
                            }
                            else if($value['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['showcause_cancel_status_id']=='1'){
                                echo 'Show Cause Revoked';
                            }                                
                            ?>
                        </td>                        
                        <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['showcause_cancel_date'], '%d-%m-%Y', ''); ?></td>
                        <td style="text-align:center; padding:2px; height:30px;">
                           <?php 
                                echo $this->Js->link('Details', array('controller' => 'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails', 'action' => 'preview', $value['LicenseModuleCancelByMraCancelOrRevokeShowCauseDetail']['org_id'],1), 
                ...
                <div class="btns-div" style="padding:7px; text-align:center;">
                    <?php
                        echo $this->Js->link('Update All', array('controller' => 'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails','action' => 'approve_edit_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Administrative Approval Update(From EVC)')));                            
                    ?>
                </div>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php 
                                echo $this->Js->link('Cancel License/Revoke Show cause', array('controller'=>'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails','action'=>'approve', $value['BasicModuleBasicInformation']['id']), 
                                                    array_merge($pageLoading, array('class'=>'btnlink')))
                                        . $this->Js->link('Details', array('controller' => 'LicenseModuleCancelByMraCancelOrRevokeShowCauseDetails','action' => 'preview', $value['BasicModuleBasicInformation']['id'],0), 
                                                                array_merge($pageLoading, array('class'=>'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
                    </tr>
