...
<div>
    <?php
    $title = (!empty($payment_type_id) && !empty($payment_types[$payment_type_id])) ? "$payment_types[$payment_type_id] Payment Notification Details" : "Payment Notification Details";
        ...
        <div class="form">
            <table cellpadding="8" cellspacing="8" border="0">
                ...
                <tr>
                    ...
                    <td>
                        <?php
                        echo $this->Form->input('payment_notify_date', array('type' => 'hidden', 'value' => date("Y-m-d"), 'label' => false, 'div' => false));
                        echo $this->Form->input("payment_deadline_date", array('type' => 'hidden', 'id' => 'txtPaymentDeadlineDate_alt', 'label' => false, 'div' => false))
                                    . "<input type='text' id='txtPaymentDeadlineDate' class='date_picker' />";
                        ?>
                    </td>
                </tr>
                <tr>
                    <td style="vertical-align:top;">Payment Letter</td>
                    <td class="colons" style="vertical-align:top;">:</td>
                    <td><?php echo $this->Form->input('payment_message', array('type' => 'textarea', 'label' => false, 'div' => false)); ?></td>
                </tr>
            </table>
        </div>
        <div class="btns-div">
