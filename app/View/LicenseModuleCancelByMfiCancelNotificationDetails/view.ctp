<?php
    if(!empty($msg)) {
        ...
        $title = "License Cancel Notification";
...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleCancelByMfiCancelNotificationDetailCompleted'); ?>
                            ...
                            <table class="view">
                                ...
                                <tr>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        <?php
                                            ...
                                            if($current_state==$next_viewable_states[0]){
                                                ...
                                                echo "<p style='background-color:#037108;color:#fff;'>Treated as <strong>Licensed</strong> and Notification sent</p>";
                                            }
                                            else{
                                    ...
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleCancelByMfiCancelNotificationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleCancelByMfiCancelNotificationDetailPending');
                    ?>
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'LicenseModuleCancelByMfiApprovalDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id'],1), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     

                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '187px';
                                        $actions = $actions.$this->Js->link('Send Notification', array('controller'=>'LicenseModuleCancelByMfiCancelNotificationDetails', 'action'=>'send_notification', $value['BasicModuleBasicInformation']['id']), 
