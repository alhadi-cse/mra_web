            ...
            <div class="form">
                <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td>
                            <?php
                                echo $this->Form->input('supervision_basic_id', array('type' => 'select', 'options' => $org_name_options, 'empty' => '---Select---', 'label' => false));
                            ?>
                        </td>
                    </tr>                     
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="colons">:</td>
                        <td><?php echo $this->Form->input('title_of_problem_id', array('type' => 'select', 'options' => 'null', 'id' => 'title_of_problems', 'empty' => '---Select---', 'label' => false)); ?></td>
                    </tr>
                    <tr>
            ...
            <div class="btns-div"> 
                <table style="margin:0 auto; padding:0;" cellspacing="5">
                    <tr>
                        ...
                        <td>
                            <?php
                                echo $this->Js->submit('Save', array_merge($pageLoading, array('success' => "msg.init('success', '$title', 'A Problemshas been added successfully.');",
