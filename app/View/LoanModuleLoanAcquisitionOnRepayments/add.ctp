            ...
            <div class="form">
                <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td class="colons">:</td>
                        <td><?php echo $this->Form->input('repayment_mode_type_id',array('type'=>'select','options'=>$repayment_mode_type_options,'empty'=>'---Select---','label'=>false));?></td>
                    </tr>
                    <tr>
                        <td>Year & Month</td>
                        <td class="colons">:</td>
            ...
            <div class="btns-div"> 
                <table style="margin:0 auto; padding:0;" cellspacing="5">
                    <tr>
                        ...
                        <td>
                            <?php 
                                echo $this->Js->link('Close', array('controller'=>'LoanModuleLoanAcquisitionOnRepayments', 'action'=>'view'), 
...
$this->Js->get('#org_names')->event('change', 
    $this->Js->request(array(
        'controller'=>'LoanModuleLoanAcquisitionOnRepayments',
