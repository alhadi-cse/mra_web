<div id="basicInfo" title="Detail" style="margin:0px; padding:10px; background-color:#fafdff;"> 
    <fieldset>        
...
<!--                <div style="margin:5px 10px; font-weight:bold;">
                    Name of Organization: 
                    <?php
//                    if (!empty($issued_letter_details[0]['BasicModuleBasicInformation'])) {
//                        $orgDetail = $issued_letter_details[0]['BasicModuleBasicInformation'];
