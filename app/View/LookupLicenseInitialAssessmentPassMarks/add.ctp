<div id="frmStatus_add">
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LookupLicenseInitialAssessmentPassMark'); ?>
        <div class="form">           
       ...
       <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupLicenseInitialAssessmentPassMarks','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
