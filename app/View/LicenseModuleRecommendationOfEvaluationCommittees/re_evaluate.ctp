    ...
    <fieldset>
        ...
        <div class="form">
            <p style="border-bottom:2px solid #137387; padding:0 0 0 15px;">
                Name of Organization: <strong><?php echo $orgName; ?></strong><?php 
                    echo $this->Js->link('Field Inspection Details', array('controller'=>'LicenseModuleFieldInspectionDetailInfos','action'=>'preview', $org_id), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block;', 'update'=>'#popup_div')));
                ?>
            </p>
            ...
            <table cellpadding="8" cellspacing="8" border="0">
                ...
                <tr>
                    ...
                    <td class="colons" style="vertical-align:top;">:</td>
                    <td style="vertical-align:top; padding-left:10px;"><?php echo $this->Form->input('comment',array('type' => 'textarea', 'div' => false, 'escape' => false, 'label' => false)); ?></td>
                </tr>
            </table>      
        </div>
        <div class="btns-div"> 
...
//        if($("input:radio.recommendation_status").attr("value") == '0') {
