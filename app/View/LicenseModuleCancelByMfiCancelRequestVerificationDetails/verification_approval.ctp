...
<div>
    ...
    <fieldset>
        <legend>License Cancel Request Verification Approval</legend> 
        <?php echo $this->Form->create('LicenseModuleCancelByMfiCancelReqVerifyApprovalDetail'); ?>
            ...
            <tr>
                <td colspan="3" style="border-bottom:2px solid #137387; padding:0;">
                    <p style="padding:0 0 0 15px;">
                        ...
                        echo $this->Js->link('Cancel Request Details', array('controller' => 'LicenseModuleCancelByMfiCancelRequests', 'action' => 'preview', $org_id), array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'display:inline-block;', 'update' => '#popup_div')));
                        ?>
                    </p>
                </td>
            </tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    ...
                    <?php  echo $this->Js->link('Close', array('controller' => 'LicenseModuleCancelByMfiCancelRequestVerificationDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns'))); ?> 
                    </td>
