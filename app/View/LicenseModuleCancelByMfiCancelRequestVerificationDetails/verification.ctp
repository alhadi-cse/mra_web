...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleCancelByMfiCancelRequestVerificationDetail'); ?>
        <div class="form">
                ...
                <tr>
                    <td colspan="3" style="border-bottom:2px solid #137387; padding:0;">
                        <p style="padding:0 0 0 15px;">
                            ...
                            echo $this->Js->link('Previous Details', array('controller' => 'LicenseModuleCancelByMfiCancelRequestVerificationDetails', 'action' => 'preview', $org_id), array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'display:inline-block;', 'update' => '#popup_div')));
                            ?>
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>Cancel Request Verification Status</td>
                    <td class="colons">:</td>
                    <td>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleCancelByMfiCancelRequestVerificationDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns'))); 
                       ?> 
                    </td>
                        ...
                        <?php
                            echo $this->Js->submit('Submit', array_merge($pageLoading, 
                                                    array('confirm' => "Are you sure to Submit ?", 
                                                          'success' => "msg.init('success', '$title', 'Cancel request has been verified successfully.');",
