                ...
                <?php if ($data_count == 1) { ?>
                    <table cellpadding="7" cellspacing="8" border="0" style="width:100%;">
                        <tr>
                            ...
                            <td style="min-width:375px">
                                ...
                                <span style="float:right;">
                                    ...
                                    if ($isEditable)
                                        echo $this->Js->link('Edit', array('controller' => 'BasicModuleBranchInfos',
                                            'action' => 'edit', $allDataDetails['BasicModuleBranchInfo']['id'], $allDataDetails['BasicModuleBranchInfo']['org_id'], 2), array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'margin:0; padding:4px;')));
                                    ?>
                                </span>
                            </td>
                        </tr>
                        <tr>
                            <td>Branch Name</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleBranchInfo']['branch_name']; ?></td>
                        </tr>
                        <tr>
                            <td>District</td>
                            <td class="colons">:</td>
                        ...
                        <tr>
                            <td>Latitude</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleBranchInfo']['lat']; ?></td>
                        </tr>				
                        <tr>
                            <td>Longitude</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleBranchInfo']['long']; ?></td>
                        </tr>
                    </table> 
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (empty($data_count) || $data_count === 0) {
                            echo $this->Js->link('Add New', array('controller' => 'BasicModuleBranchInfos', 'action' => 'add'), $pageLoading);
                        } else {
                            echo $this->Js->link('Close', array('controller' => 'BasicModuleBranchInfos', 'action' => 'view'), $pageLoading);
                        }
                        ?>
                    </td>
                    <td></td>
