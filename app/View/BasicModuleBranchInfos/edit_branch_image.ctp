...
if (isset($msg) && !empty($msg)) {
    ...
    $title = "Update the Picture of Branch Office";
            ...
            <div class="btns-div">                
                <table style="margin:0 auto; padding:0;" cellspacing="7">
                    <tr>
                        <td></td>
                        <td>
                            <input id="btnUpload" type="button" class="mybtns" value="Upload & Next" style="display:none" />
                            <?php
                            echo $this->Js->submit('Next', array_merge($pageLoading, array('id' => 'btnNext', 'success' => "msg.init('success', '$title', 'Only Branch Information Updated Successfully But No Picture is Updated!');",
                                'error' => "msg.init('error', '$title', '$title has been failed to add !');")));

//                            echo $this->Js->submit('Upload & Next', array_merge($pageLoading, array('id' => 'btnUpload', 'success' => "msg.init('success', '$title', 'Only Branch Information Updated Successfully But No Picture is Updated!');",
//                                'error' => "msg.init('error', '$title', '$title has been failed to add !');")));
                            ?>
                        </td>
                        <td></td>
...
//        alert(branchId);
        $.ajax({
            ...
            success: function (data) {
                alert(data);
                $("#busy-indicator").fadeOut();
                msg.init('success', 'Branch Information... . .', 'Office Information and Picture Updated Successfully !');
                $("#ajax_div").html(data);
                return false;
            }
        });
