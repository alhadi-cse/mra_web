                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            echo $this->Form->input('BasicModuleBranchInfo.activation_request_date', array('type'=>'hidden', 'value' => $this->Time->format(new DateTime('now'),'%Y-%m-%d',''), 'label'=>false));
                        ?>
                    </td>
                </tr>                
                <tr>
                    ...
                    <td><?php echo $this->Form->input('BasicModuleBranchInfo.activation_reasons',array('type'=>'textarea', 'escape' => false, 'div'=>false, 'label'=>false)); ?></td>
                </tr>                              
            </table>                       
        </div> 
        <div class="btns-div"> 
