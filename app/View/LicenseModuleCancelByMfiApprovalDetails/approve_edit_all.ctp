...
$title = "Edit $approvalType Approval for Canceling License";
            ...
            if (empty($values_approved) || !is_array($values_approved) || count($values_approved) < 1) {
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleCancelByMfiApprovalDetail.inspection_date', 'Inspection Date') . "</th>";
                    ...
                    foreach ($values_approved as $value) {
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <?php
                                echo $this->Form->input("$rc.org_id", array('type' => 'hidden', 'value' => $value['LicenseModuleCancelByMfiApprovalDetail']['org_id'], 'label' => false));
                            ...
                            <td><?php echo date("d-m-Y", strtotime($value['LicenseModuleCancelByMfiApprovalDetail']['inspection_date'])); ?></td>
