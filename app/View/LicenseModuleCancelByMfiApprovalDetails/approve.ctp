    ...
    <fieldset>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php echo $this->Js->link('Close', array('controller' => 'LicenseModuleCancelByMfiApprovalDetails', 'action' => 'view?this_state_ids=' . $this_state_ids.'&committee_group_id='.$committee_group_id.'&approval_states='.$approval_states), array_merge($pageLoading, array('class' => 'mybtns'))); ?> 
                    </td>
