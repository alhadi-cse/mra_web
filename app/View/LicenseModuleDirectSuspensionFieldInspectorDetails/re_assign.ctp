        ...
        <div class="btns-div">
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php
                        echo $this->Js->link('Close', array('controller' => 'LicenseModuleDirectSuspensionFieldInspectorDetails', 'action' => 'view', '?' => array('inspector_group_id' => $inspector_group_id)), array_merge($pageLoading, array('class' => 'mybtns')));
                        ?> 
                    </td>
...
<?php
    ...
    $this->Js->get('#districts')->event('change', $this->Js->request(array(
            'controller' => 'LicenseModuleDirectSuspensionFieldInspectorDetails',
