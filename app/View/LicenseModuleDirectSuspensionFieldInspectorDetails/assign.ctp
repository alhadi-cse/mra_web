<div>
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LicenseModuleDirectSuspensionFieldInspectorDetail'); ?>
        <div class="form">
                        ...
                        foreach ($orgDetailsAll as $data_key => $orgDetails) {
                            if ($orgDetails['BasicModuleBranchInfo']['district_id'] == $dist_id) {
                                ...
                                $row = $row . '<td style="font-weight:bold;">'
                                        . $this->Form->input("$dist_id.org_ids.$rowspan", array('type' => 'checkbox', 'value' => $org_id, 'div' => false, 'label' => $orgDetails['BasicModuleBasicInformation']['form_serial_no'])) . '</td>'
       ...
       <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php                                
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleDirectSuspensionFieldInspectorDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                        ?> 
                    </td>
                    <td style="text-align: center;">
                        <?php 
