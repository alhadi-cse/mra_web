        ...
        <div class="form">
            ...
            <fieldset style="margin-top:10px">
                ...
                <table class="view">
                    <tr>
                        <?php 
                            echo "<th style='width:100px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.form_serial_no', 'Form Serial No.') . "</th>";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (!empty($values_pending) && is_array($values_pending) && count($values_pending) > 0)
                            echo $this->Js->link('Assign', array('controller'=>'LicenseModuleDirectSuspensionFieldInspectorDetails','action'=>'assign'), 
                    ...
                    <td>
                        <?php 
                        if(!empty($allRows))
                            echo $this->Js->link('Re-assign', array('controller'=>'LicenseModuleDirectSuspensionFieldInspectorDetails','action'=>'re_assign'), 
                                                    array_merge($pageLoading, array('class'=>'mybtns')));
                        ?>
                    </td>
                    <td></td>   
