...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if (empty($org_id)) {
                echo $this->Form->create('LicenseModuleCancelByMraExplanationVerificationDetail');
                ?>
            ...
            <fieldset>
                <legend>Verification of Explanation Against Show Cause Completed</legend>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleCancelByMraExplanationVerificationDetail.verification_date', 'Verification Date') . "</th>";
                    ...
                    <?php foreach ($values_verified as $value) { ?>
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleCancelByMraExplanationVerificationDetail']['verification_date'], '%d-%m-%Y', ''); ?></td>
                            <td style="text-align:justify; padding:2px; height:30px;">
                                <?php
                                    echo $this->Js->link('Details', array('controller' => 'LicenseModuleCancelByMraExplanationVerificationDetails', 'action' => 'preview', $value['LicenseModuleCancelByMraExplanationVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                                ?>     
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <fieldset>
                <legend>Verification of Explanation Against Show Cause Not Approved</legend>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="text-align:justify; padding:2px; height:30px;">
                            ...
                            if (!empty($user_is_committee_member)) 
                                echo $this->Js->link('Approve', array('controller' => 'LicenseModuleCancelByMraExplanationVerificationDetails', 'action' => 'verification_approval', $value['LicenseModuleCancelByMraExplanationVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));
                    ...
                    <tr>
                        ...
                        <td style="text-align:justify; padding:2px; height:30px;">
                            <?php
                            if (!empty($user_is_committee_member)) 
                                echo $this->Js->link('Re-Approve', array('controller' => 'LicenseModuleCancelByMraExplanationVerificationDetails', 'action' => 'verification_re_approval', $value['LicenseModuleCancelByMraExplanationVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));                            
            ...
            <fieldset>
                <legend>Verification of Explanation Against Show Cause Verification Pending</legend>
                <?php
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:justify;"> 
                            <?php                            
                            if (!empty($user_is_committee_member)) {
                                echo $this->Js->link('Verification', array('controller' => 'LicenseModuleCancelByMraExplanationVerificationDetails', 'action' => 'verification', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                            }
                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleCancelByMraExplanationVerificationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
...
//                    . $this->Js->link('Verify All', array('controller' => 'LicenseModuleCancelByMraExplanationVerificationDetails', 'action' => 'verification_all'), array_merge($pageLoading, array('class' => 'mybtns', 'title' => 'Initial Assessment Verify All')))
//                    . '</div>';
//                }
            }
            ?>
