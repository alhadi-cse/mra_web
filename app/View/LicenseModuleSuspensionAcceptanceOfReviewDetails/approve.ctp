...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleSuspensionAcceptanceOfReviewDetail'); ?>
            ...
            <table style="width:100%;" cellpadding="8" cellspacing="8" border="0">
                <tr>
                    ...
                    <?php 
                        ...
                        echo $this->Js->link('Pre. Details', array('controller'=>'LicenseModuleSuspensionAcceptanceOfReviewDetails','action'=>'preview', $org_id), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block; float:right;', 'update'=>'#popup_div')));
                    ?>
                    </td>
                </tr>
                <tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleSuspensionAcceptanceOfReviewDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
