...
<style>
    ...
    .tbl-rpt-view tr.selected td, .tbl-rpt-view tr.odd.selected td {
        color: #fff;
        background: #0073aa;
                    ...
                    foreach ($group_wise_field_title as $group_id => $field_list) {
                        ...
                        foreach ($field_list as $field_id => $field) {
                            ...
                            if (isset($selected_field_list[$field_id])) {
                                ...
                                if (strtotime($data_value)) {
                                    $data_value = date('d-m-Y', strtotime($data_value));
                                    $dr_data .= "<td style='text-align:center;'>$data_value</td>";
                                } elseif (is_numeric(str_replace(array(' ', '%'), array('', ''), $data_value))) {
                                    $dr_data .= "<td style='text-align:right;'>$data_value</td>";
                                } else {
                                    $dr_data .= "<td style='text-align:left;'>$data_value</td>";
                                }
                            } else {
                                $dr_data .= "<td></td>";
                            }
