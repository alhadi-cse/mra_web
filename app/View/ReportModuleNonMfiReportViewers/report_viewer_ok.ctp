                ...
                <td style="vertical-align:top;">
                    <fieldset style="margin:0 5px 5px;">
                        ...
                        <div id="divReport" style="width:auto; height:100%; min-width:300px; min-height:300px; max-height:485px; max-height:58vh; padding:2px 2px 5px 7px; line-height:1.8; overflow:auto;">
                            ...
                            <?php
                            echo $this->Form->create('ReportModuleReportViewerSelect');

                            //debug($report_list);
                            //$report_list = array('Report List' => array($report_list));

                            echo '<fieldset style="margin:0 5px 5px;">'
                            . '<legend>▣ Loan and Savings Reports</legend>';
                            ...
                            echo '<fieldset style="margin:0 5px 5px;">'
                            . '<legend>▣ Others Reports</legend>';
                            echo $this->Form->input("ReportList", array('id' => 'reportId', 'type' => 'radio', 'class' => 'multi-radio rpt-list', 'options' => $report_list, 'separator' => '<br />', 'escape' => false, 'legend' => false, 'div' => false, 'label' => true));
                            echo $this->Form->end();
                            echo '</fieldset>';
