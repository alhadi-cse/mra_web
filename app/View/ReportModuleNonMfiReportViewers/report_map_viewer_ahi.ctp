        ...
        <table>
            <tr>
                <td style='vertical-align:top;'>
                    <select id="bd_info" style="width:120px;">
                ...
                <td style='vertical-align:top;'>
                    <?php
                    echo "<div>" . $this->Form->input('', array('id' => 'org_list', 'type' => 'select', 'class' => 'org_opt', 'style' => 'position:absolute;left:145px;width:300px;', 'options' => $org_list, 'value' => $org_id, 'empty' => '--------- All MFIs --------', 'escape' => false, 'div' => false, 'label' => false))
                    . "</div><div style='width:325px; margin:0; padding:0;'></div></td>"
                    . "<td style='vertical-align:top;'>"
...
//            // || map_data.constructor !== Array
            ...
            var data_info, map_poly, poly_center, mapStyle;
    ...
    if (!empty($branch_infos)) {
        ...
        echo $this->Html->scriptBlock("map_data = $branch_infos; $('#bd_info').val('$admin_code'); map_init('$admin_code');", array('inline' => true));
    }
    ?>
