            ...
            <table style="width: 100%;">
                <tr>
                    <td colspan="2" style='vertical-align:top; text-align:left; padding:3px 0;'>
                        <?php
                        $bd_admins = array('dist' => 'District', 'upaz' => 'Upazila');
                        echo $this->Form->input('', array('name' => 'bd_info', 'type' => 'radio', 'options' => $bd_admins, 'empty' => 'None', 'escape' => false, 'legend' => 'Admin Boundary', 'div' => false, 'label' => true));
                        echo $this->Form->input('', array('name' => 'branch_types', 'type' => 'radio', 'options' => $branch_types, 'value' => $branch_type_id, 'empty' => 'All Type', 'escape' => false, 'legend' => 'Branch Office Type', 'div' => false, 'label' => true));
                        ?>
                    </td>
                </tr>
                <tr>
                    <td colspan="2" style='vertical-align:top; text-align:left; padding:3px 0;'>
                        ...
                        <div>
                            <select id="bd_info_division" style="width:170px; margin-right:5px">
                                <option value="">--- Select ---</option>

                            </select>
                        </div>
                        <div>
                            <select id="bd_info_district" style="width:170px; margin-right:5px">
                                <option value="">--- Select ---</option>
                            </select>
                        </div>
                        <div>
                            <select id="bd_info_upazila" style="width:170px; margin-right:5px">
                                <option value="">--- Select ---</option>
                            </select>
                        </div>
                ...
                <tr>
                    <td style='vertical-align:top; text-align:left; padding:3px 0;'>
                        <?php
                        echo $this->Form->input('', array('id' => 'org_list', 'type' => 'select', 'class' => 'org_opt', 'style' => 'position:absolute;left:0; width:350px;', 'options' => $org_list, 'value' => $org_id, 'empty' => '--------- All MFIs --------', 'escape' => false, 'div' => false, 'label' => false))
                        ?>
                    </td>
                    <td style='vertical-align:top; text-align:left; padding:3px 0;'>
                        <?php
                        echo "<span style='margin:0; font-weight:bold;'>filter:<input type='text' id='txtFilter_org_list' style='width:100px !important; margin-left:5px;'></span>";
                        ?>
                    </td>
                </tr>
            </table>
    ...
    <script>
        ...
        function set_branch_data() {
            ...
            $.ajax({
                ...
                type: "post",
                dataType: "html",
                url: document.location + "ReportModuleReportViewers\/get_branches_location\/" + orgId + "\/" + brancheTypeId,
        ...
        function set_admin_boundary() {
            ...
            bd_admin.features.forEach(function (feature) {
                try {
                    ...
                    all_map_poly.push({div_code: admin_props.div_code, dist_code: admin_props.dist_code, upaz_code: admin_props.upaz_code, map_poly: map_poly});
        ...
        var legend_info = {
            head_office: {fill_color: '#f53', border_color: '#ef3', title: 'Head Office'},
