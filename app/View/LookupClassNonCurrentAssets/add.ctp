<div id="frmStatus_add">
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LookupClassNonCurrentAsset'); ?>
        <div class="form">           
            <table cellpadding="0" cellspacing="0" border="0">                
                ...
                <tr>
                    <td>Non-Current Asset Classification</td>
                    <td class="colons">:</td>
                    <td><?php echo $this->Form->input('non_current_asset_class',array('label'=>false)); ?></td>
                </tr>               
            </table>
        </div>        
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupClassNonCurrentAssets','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
