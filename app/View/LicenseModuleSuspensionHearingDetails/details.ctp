        ...
        <div class="datagrid" style="max-height:430px; overflow-y:auto; color:#232428;">
            <table cellpadding="7" cellspacing="8" border="0">              
                ...
                <tr>
                    <td>Hearing Date</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleSuspensionHearingDetail']['hearing_date']; ?></td>
                </tr>
                <tr>
                    <td>Hearing Details</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleSuspensionHearingDetail']['hearing_details']; ?></td>
                </tr>
            </table>
        </div>
    </fieldset>
