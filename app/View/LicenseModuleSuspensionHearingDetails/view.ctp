...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleSuspensionHearingDetailCompleted'); ?>
            ...
            <fieldset>
                <legend>Hearing Completed</legend>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        <?php
                                            ...
                                            if($licensing_state_id==$thisStateIds[1]){
                                                echo "<p style='background-color:#037108;color:#fff;'>Hearing information submitted</p>";
                                            }                                            
                                            else{
                                                echo "<p style='background-color:#713002;color:#fff;'>Not yet submitted</p>";
                                            }                                            
                                        ?>
                                    </td>
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleSuspensionHearingDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleSuspensionHearingDetailPending');
                    ?>
                            ...
                            <td>
                                <?php
                                    if(!empty($opt_all) && $opt_all) {
                                        echo $this->Js->link('View All', array('controller'=>'LicenseModuleSuspensionHearingDetails', 'action'=>'view', 'all'),
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <td style='padding:2px; text-align:justify;'>
                                    <?php echo "<p style='background-color:#713002;color:#fff;'>Not yet submitted</p>"; ?>
                                </td>
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'BasicModuleBasicInformations', 'action'=>'preview', $value['BasicModuleBasicInformation']['id'],1), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     

                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '187px';
                                        $actions = $actions.$this->Js->link('Submit Hearing', array('controller'=>'LicenseModuleSuspensionHearingDetails', 'action'=>'hearing', $value['BasicModuleBasicInformation']['id']), 
