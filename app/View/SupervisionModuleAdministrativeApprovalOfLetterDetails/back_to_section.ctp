                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        echo $this->Js->submit('Save', array_merge($pageLoading, array(
                            'url'=>"/SupervisionModulePrepareLetterDetails/prepare_letter/$org_id/$viewable_user_groups/0", 
                    ...
                    <td style="text-align: center;">
                        ...
                        echo $this->Js->submit('Submit to Section', array_merge($pageLoading, array(
                            'url'=>"/SupervisionModulePrepareLetterDetails/prepare_letter/$org_id/$viewable_user_groups/1",
                            'confirm' => "Are you sure to Submit ?",
