            ...
            <fieldset>
                ...
                <?php 
                    if($completed_values == null || !is_array($completed_values) || count($completed_values)<1) {
                        ...
                        echo 'Did not match any information!';
                        echo '</p>';
                    }
                    else {
                ?>
                            ...
                            <table class="view">
                                <tr>
                                    <?php
                                        ...
                                        echo "<th style='width:175px;'>Action</th>";
                                    ?>
                                </tr>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        <?php
                                            ...
                                            if($current_state==$thisStateIds[1]){
                                                echo "<p style='background-color:#037108;color:#fff;'>Letter is approved</p>"; 
                                            }                                            
                                            else{
                                                echo "<p style='background-color:#713002;color:#fff;'>Not yet approved</p>";
                                            }
                                        ?>
                                    </td>
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'SupervisionModulePrepareLetterDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
                                                                            array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div'))).
                                                 $this->Js->link('Cancel Approval', array('controller'=>'SupervisionModuleAdministrativeApprovalOfLetterDetails', 'action'=>'cancel_approval', $value['BasicModuleBasicInformation']['id'],$viewable_user_groups), 
                            ...
                            <td>
                                <?php
                                    if(!empty($opt_all) && $opt_all) {
                                        echo $this->Js->link('View All', array('controller'=>'SupervisionModulePrepareLetterDetails', 'action'=>'view', 'all'),
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'SupervisionModulePrepareLetterDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id'],1), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     
                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '250px';
                                        $actions = $actions.$this->Js->link('Approve', array('controller'=>'SupervisionModuleAdministrativeApprovalOfLetterDetails', 'action'=>'approve', $value['BasicModuleBasicInformation']['id'],$viewable_user_groups), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink'))); 
                                        $actions = $actions.$this->Js->link('Back to Section', array('controller'=>'SupervisionModuleAdministrativeApprovalOfLetterDetails', 'action'=>'back_to_section', $value['BasicModuleBasicInformation']['id'],$viewable_user_groups), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink')));
                                    }
                                    else{
                                        $width = '50px';                                        
