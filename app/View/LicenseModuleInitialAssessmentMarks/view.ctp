...
<div>
    <fieldset>
        ...
        <div class="form">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if (!empty($opt_all) && $opt_all) {
                                echo $this->Js->link('View All', array('controller' => 'LicenseModuleInitialAssessmentDetails', 'action' => 'view', 'all'), array_merge($pageLoading, array('class' => 'mybtns sbtns')));
                            }
                            ?>
                        </td>
                    </tr>
            ...
            <?php
                if ((!empty($values_assessed_passed) && is_array($values_assessed_passed) && count($values_assessed_passed) > 0)
                        || (!empty($values_assessed_watch_out) && is_array($values_assessed_watch_out) && count($values_assessed_watch_out) > 0)
                        || (!empty($values_assessed_failed) && is_array($values_assessed_failed) && count($values_assessed_failed) > 0)) {
            ?>
            <fieldset>
                ...
                <fieldset>
                    ...
                    <table class="view">
                        ...
                        <?php 
                        foreach ($values_assessed_passed as $value) {
                        ?>
                        <tr>
                            <td>
                                <?php
                ...
                <?php
                if (!empty($values_assessed_watch_out) && is_array($values_assessed_watch_out) && count($values_assessed_watch_out) > 0) {
                ?>
                ...
                <fieldset>
                    ...
                    <table class="view">
                        ...
                        <?php foreach($values_assessed_watch_out as $value){ ?>
                        <tr>
                            <td>
                                <?php
                                    $mfiName = $value['BasicModuleBasicInformation']['short_name_of_org'];
                            ...
                            <td style="height:30px; padding: 2px; text-align: center;">
                                ...
                                if($isAdmin)
                                    echo $this->Js->link('Re-Assess', array('controller'=>'LicenseModuleInitialAssessmentDetails', 'action'=>'re_assess', $value['BasicModuleBasicInformation']['id']), 
                ...
                <?php
                if (!empty($values_assessed_failed) && is_array($values_assessed_failed) && count($values_assessed_failed) > 0) {
                ?>
                <fieldset>
                    ...
                    <table class="view">
                        ...
                        <?php foreach($values_assessed_failed as $value){ ?>
                        <tr>
                            <td>
                                <?php
                                    $mfiName = $value['BasicModuleBasicInformation']['short_name_of_org'];
                ...
                <?php
//                if ($isAdmin && ((!empty($values_assessed_watch_out) && is_array($values_assessed_watch_out) && count($values_assessed_watch_out) > 0) 
//                    || (!empty($values_assessed_failed) && is_array($values_assessed_failed) && count($values_assessed_failed) > 0))) {
//                    
//                    echo '<div style="text-align:center;">'
//                            . $this->Js->link('Application Rejection', array('controller' => 'LicenseModuleApplicationRejectionDetails', 'action' => 'view', 7, 21, 50), array_merge($pageLoading, array('class' => 'mybtns', 'style' => 'margin:10px auto;')))
//                            . '</div>';
//                }
                ?>
            ...
            <fieldset>
                ...
                <?php
                if (empty($values_assessed_not_submit) || !is_array($values_assessed_not_submit) || count($values_assessed_not_submit) < 1) {
                    echo '<p class="error-message">';
                    echo 'There is no pending form for submit !';
                    echo '</p>';
                } else {
                ?>
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;">
                            ...
                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleInitialAssessmentDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')))
                                    .$this->Js->link('Re-Assess', array('controller'=>'LicenseModuleInitialAssessmentDetails', 'action'=>'re_assess', $value['BasicModuleBasicInformation']['id']), 
                                                array_merge($pageLoading, array('class'=>'btnlink')));
                            ?>
                        </td>
                    </tr>
            ...
            <fieldset>
                ...
                <?php
                    if(empty($values_not_evaluat) || !is_array($values_not_evaluat) || count($values_not_evaluat) < 1) {
                        echo '<p class="error-message">';
                        echo 'There is no pending form for this assessor !';
                        echo '</p>';
                    }
                    else {
                ?>
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;">
                            <?php
                                echo $this->Js->link('Assess', array('controller'=>'LicenseModuleInitialAssessmentDetails', 'action'=>'assess', $value['BasicModuleBasicInformation']['id']), 
                                                    array_merge($pageLoading, array('class'=>'btnlink')));
                            ?>
                        </td>
                    </tr>
