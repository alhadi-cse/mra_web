...
<div>
    <?php 
       $title = "Initial Assessment Details";
    ?>
            ...
            ?>
                ...
                <tr <?php if ($rc%2==0) echo ' class="alt"'; ?>>
                    ...
                    <td>
                        ...
                        echo $this->Form->input("LicenseModuleInitialAssessmentDetail.$rc.parameter_id", array('type'=>'hidden', 'value'=>$parameter_id, 'label'=>false)); 
                        ?>
                    </td>
