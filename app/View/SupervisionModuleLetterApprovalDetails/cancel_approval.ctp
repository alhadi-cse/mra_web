...
$title = htmlspecialchars("$approvalType's " . $approval_title . " of Letter Approval", ENT_QUOTES);
            ...
            <table cellpadding="6" cellspacing="7" border="0">
                <tr>
                    ...
                    <td style="font-weight: bold;">
                        <?php
                        echo $orgName . "  " . $this->Js->link('Details', array('controller' => 'SupervisionModulePrepareLetterDetails', 'action' => 'preview', $supervision_basic_id), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                        ?>
                    </td>
                </tr>          
                <tr>
                    ...
                    <td>
                        <?php
                        echo $this->Form->input('tier_wise_comments_on_letters', array('type' => 'textarea', 'escape' => false, 'div' => false, 'label' => false, 'style' => 'width: 580px; height:70px;'));
                        ?>
                    </td>
                </tr>                
            </table>                       
