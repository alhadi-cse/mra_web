...
$title = "Edit $approvalType Approval of Letter";
...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('SupervisionModuleLetterApprovalDetailAll'); ?>
            ...
            if (empty($values_approved) || !is_array($values_approved) || count($values_approved) < 1) {
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('SupervisionModulePrepareLetterDetail.inspection_date', 'Inspection Date') . "</th>";
                    ...
                    foreach ($values_approved as $value) {
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <?php
                                echo $this->Form->input("$rc.supervision_basic_id", array('type' => 'hidden', 'value' => $value['SupervisionModulePrepareLetterDetail']['supervision_basic_id'], 'label' => false));
                            ...
                            <td><?php echo date("d-m-Y", strtotime($value['SupervisionModulePrepareLetterDetail']['inspection_date'])); ?></td>
        ...
        <div class="btns-div">                
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php
                        echo $this->Js->link('Close', array('controller' => 'SupervisionModuleLetterApprovalDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns', 'confirm' => 'Are you sure to Close ?', 'title' => 'Back to Previous Page')));
                        ?> 
                    </td>
                    <td style="text-align: center;">
                        <?php
                        echo $this->Js->submit('Update All', array_merge($pageLoading, array('class' => 'mybtns', 'confirm' => 'Are you sure to update all approval ?', 'title' => 'Update All Approval',
                                                                'success' => "msg.init('success', '$title', '$title has been update successfully.');", 'error' => "msg.init('error', '$title', 'Insertion failed!');")));
                        ?>
                    </td>
                </tr>
            </table>
