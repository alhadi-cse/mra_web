...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleDirectSuspensionNotificationDetailCompleted'); ?>
                            ...
                            <table class="view">
                                ...
                                <tr>
                                    ...
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionNotificationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleDirectSuspensionNotificationDetailPending');
                    ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    $width = '187px';
                                    $actions = $actions.$this->Js->link('Send Notification', array('controller'=>'LicenseModuleDirectSuspensionNotificationDetails', 'action'=>'send_notification', $value['BasicModuleBasicInformation']['id']), 
