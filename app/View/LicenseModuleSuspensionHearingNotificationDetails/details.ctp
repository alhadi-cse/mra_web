        ...
        <div class="datagrid" style="max-height:430px; overflow-y:auto; color:#232428;">
            <table cellpadding="7" cellspacing="8" border="0">              
                ...
                <tr>
                    <td>Notify Date</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleSuspensionHearingNotificationDetail']['notify_date']; ?></td>
                </tr>
                <tr>
                    <td>Notification Details</td>
                    <td class="colons">:</td>
                    <td><?php echo $allDetails['LicenseModuleSuspensionHearingNotificationDetail']['notification_details']; ?></td>
                </tr>
            </table>
        </div>
    </fieldset>
