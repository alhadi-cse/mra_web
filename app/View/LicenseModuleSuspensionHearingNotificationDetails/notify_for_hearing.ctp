...
<div id="frmBasicInfo_add">
    <fieldset>
        ...
        <?php                 
            echo $this->Form->create('LicenseModuleSuspensionHearingNotificationDetail');
        ?>           
        <div class="form">            
            <table cellpadding="5" cellspacing="7" border="0">
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td>
                        <?php echo $this->Form->input('notify_date',array('type'=>'text', 'class'=>'date_picker', 'div'=>false, 'label'=>false));?>
                    </td>
                </tr>                
                <tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php echo $this->Js->link('Close', array('controller' => 'LicenseModuleSuspensionHearingNotificationDetails','action' => 'view?this_state_ids='.$this_state_ids),array_merge($pageLoading, array('class'=>'mybtns'))); ?>
                    </td>
