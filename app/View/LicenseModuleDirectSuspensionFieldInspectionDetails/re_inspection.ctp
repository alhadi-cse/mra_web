...
//
//                            $submission_date = $this->request->data['LicenseModuleCancelByMraFieldInspectionDetail']['submission_date'];
                    ...
                    <td style="text-align:center;">
                        <?php
                            echo $this->Js->submit('Update', array_merge($pageLoading, 
                                                    array('url'=>"/LicenseModuleCancelByMraFieldInspectionDetails/re_inspection/$org_id/0", 
                    ...
                    <td style="text-align:center;">
                        <?php
                            echo $this->Js->submit('Submit', array_merge($pageLoading, 
                                                    array('url'=>"/LicenseModuleCancelByMraFieldInspectionDetails/re_inspection/$org_id/1", 
