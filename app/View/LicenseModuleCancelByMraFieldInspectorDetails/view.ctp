                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (!empty($values_pending) && is_array($values_pending) && count($values_pending) > 0)
                            echo $this->Js->link('Assign', array('controller'=>'LicenseModuleCancelByMraFieldInspectorDetails','action'=>'assign'), 
                    ...
                    <td>
                        <?php 
                        if(!empty($allRows))
                            echo $this->Js->link('Re-assign', array('controller'=>'LicenseModuleCancelByMraFieldInspectorDetails','action'=>'re_assign'), 
                                                    array_merge($pageLoading, array('class'=>'mybtns')));
                        ?>
                    </td>
                    <td></td>   
