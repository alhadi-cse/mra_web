                                    ...
                                    <td>
                                        ...
                                        <?php 
                                            ...
                                            foreach ($approval_status_options as $value => $text) {
                                                echo "<input type='radio' style='margin:2px;' name='data[LicenseModuleInitialAssessmentReviewVerificationDetailAll][$rc][approval_status_id]' ";
...
//                                        {
//                                            echo '<input id="x" type="radio" value="'.$approval_status_option["approval_status"].'" style="margin:2px;" name="data[LicenseModuleInitialAssessmentReviewVerificationDetailAll][0][approval_status_id]">';
//                                        }
