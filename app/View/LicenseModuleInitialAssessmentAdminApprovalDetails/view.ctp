            ...
            <fieldset>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:70px;'>" . $this->Paginator->sort('LicenseModuleInitialAssessmentAdminApprovalDetail.approval_date', 'Approval Date') . "</th>";
...
<!--                        <td style="text-align:center;"><?php //echo $value['LookupLicenseApprovalStatus']['approval_status']; ?></td>                        -->
                        <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleInitialAssessmentAdminApprovalDetail']['approval_date'], '%d-%m-%Y', ''); ?></td>
                        <td style="text-align:center; padding:2px; height:30px;">
                            <?php
                            echo $this->Js->link('Re-Approve', array('controller' => 'LicenseModuleInitialAssessmentAdminApprovalDetails', 'action' => 're_approve', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')))
                                    . $this->Js->link('Details', array('controller' => 'LicenseModuleInitialAssessmentAdminApprovalDetails', 'action' => 'preview', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
                    </tr>
                    <?php  } ?>
                ...
                <?php
                    ...
                    if (!empty($user_group_id) && in_array(1,$user_group_id)) {
                        echo '<div style="text-align:center;">'
                            . $this->Js->link('Rejection of Application', array('controller' => 'LicenseModuleApplicationRejectionDetails', 'action' => 'view', 7, 21, 50), array_merge($pageLoading, array('class' => 'mybtns', 'style' => 'margin:10px auto;')))
                            . '</div>';
                }
                ?>
                ...
                <div class="btns-div" style="padding:7px; text-align:center;">
                    <?php
                        echo $this->Js->link('Update All', array('controller' => 'LicenseModuleInitialAssessmentAdminApprovalDetails','action' => 'approve_edit_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Administrative Approval Update(From EVC)')));                            
                    ?>
                </div>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php 
                                echo $this->Js->link('Approve', array('controller'=>'LicenseModuleInitialAssessmentAdminApprovalDetails','action'=>'approve', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class'=>'btnlink')))
                                        ...
                                        . $this->Js->link('Details', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails','action' => 'preview', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class'=>'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
                    </tr>
                  <?php } ?>
                ...
                <?php
                    ...
                    if(count($values_not_approved) > 1 ) {
                        echo '<div class="btns-div" style="padding:7px; text-align:center;">'
                                . $this->Js->link('Approve All', array('controller' => 'LicenseModuleInitialAssessmentAdminApprovalDetails','action' => 'approve_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Initial Assessment Approve All')))
                                . '</div>';
                    }
                }
                ?>
