                            ...
                            <tr>
                                <td style="text-align:center;">
                                    <?php 
                                        ...
                                        echo $this->Form->input("$rc.id", array('type'=>'hidden', 'value'=>$orgDetail['LicenseModuleInitialAssessmentAdminApprovalDetail']['id'], 'label'=>false));    
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($approval_status_options as $value => $text) {
                                            ...
                                            if($value==$orgDetail['LicenseModuleInitialAssessmentAdminApprovalDetail']['approval_status_id']){ echo 'checked'; }
                                ...
                                <td>
                                    <?php 
                                        echo $this->Time->format($orgDetail['LicenseModuleInitialAssessmentAdminApprovalDetail']['approval_date'],'%d-%m-%Y','');
                                        echo $this->Form->input("$rc.approval_date", array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                                    ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.reason_if_not_approved",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleInitialAssessmentAdminApprovalDetail']['reason_if_not_approved'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.comment",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleInitialAssessmentAdminApprovalDetail']['comment'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
