...
<div id="recEvalInfo" title="Administrative Approval of Initial Assessment" style="margin:0px; padding:8px; background-color:#fafdff;">
    
    <div id="tabs">
        <ul>
          <li><a href="#tabs-1">Initial Assessment</a></li>
          <li><a href="#tabs-2">Initial Assessment Review and Verification</a></li>
          <li><a href="#tabs-3">Administrative Approval of Initial Assessment</a></li>
        </ul>
