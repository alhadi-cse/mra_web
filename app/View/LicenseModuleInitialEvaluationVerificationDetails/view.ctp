...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if (empty($org_id)) {
                echo $this->Form->create('LicenseModuleInitialEvaluationVerificationDetail');
                ?>
            ...
            <fieldset>
                <legend>Initial Evaluation Verification Completed</legend>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleInitialEvaluationVerificationDetail.verification_date', 'Verification Date') . "</th>";
                    ...
                    <?php foreach ($values_verified as $value) { ?>
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleInitialEvaluationVerificationDetail']['verification_date'], '%d-%m-%Y', ''); ?></td>
                            <td style="text-align:center; padding:2px; height:30px;">
                                <?php
                                    echo $this->Js->link('Details', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails', 'action' => 'preview', $value['LicenseModuleInitialEvaluationVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                                ?>     
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <fieldset>
                <legend>Initial Evaluation Verification Not Approved</legend>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; padding:2px; height:30px;">
                            ...
                            if ($user_is_committee_member) {
                                echo $this->Js->link('Approve', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails', 'action' => 'verification_approval', $value['LicenseModuleInitialEvaluationVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));
                            }
                            echo $this->Js->link('Details', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails', 'action' => 'preview', $value['LicenseModuleInitialEvaluationVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
            ...
            <fieldset>
                <legend>Initial Evaluation Verification Pending</legend>
                <?php
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php
                            echo $this->Js->link('Pre. Details', array('controller' => 'LicenseModuleFieldInspectionDetails', 'action' => 'preview', $value['BasicModuleBasicInformation']['id'], 1), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                            if ($user_is_committee_member) {
                                echo $this->Js->link('Verification', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails', 'action' => 'verification', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                            }
                            ?>
                        </td>
                    </tr>
                ...
                if (count($values_pending) > 1 && !empty($user_is_committee_member)) {
                    ...
                    . $this->Js->link('Verify All', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails', 'action' => 'verification_all'), array_merge($pageLoading, array('class' => 'mybtns', 'title' => 'Initial Evaluation Verify All')))
                    . '</div>';
                }
            }
            ?>
