...
<div>
    ...
    <fieldset>
        <legend>Initial Evaluation Verification Approval</legend> 
        <?php echo $this->Form->create('LicenseModuleInitialEvaluationVerificationApprovalDetail'); ?>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    ...
                    <?php  echo $this->Js->link('Close', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns'))); ?> 
                    </td>
