...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleInitialEvaluationVerificationDetailAll'); ?>
                    ...
                    <div style="width:780px; height:auto; padding:0; overflow-x:auto;">
                        <?php 
                            if($orgDetails==null || !is_array($orgDetails) || count($orgDetails)<1) {
                                ...
                                echo $this->Js->link('Back', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));
                            }
                            else {
                        ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                <td style="display:none;">
                                    <?php 
                                        echo $this->Form->input("$rc.id", array('type'=>'hidden', 'value'=>$orgDetail['LicenseModuleInitialEvaluationVerificationDetail']['id'], 'label'=>false));    
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($verification_status_options as $value => $text) {
                                            echo "<input type='radio' style='margin:2px;' name='data[LicenseModuleInitialEvaluationVerificationDetailAll][$rc][verification_status_id]' ";
                                            if($value==$orgDetail['LicenseModuleInitialEvaluationVerificationDetail']['verification_status_id']){ echo 'checked'; }
                                ...
                                <td>
                                    <?php 
                                        echo $this->Time->format($orgDetail['LicenseModuleInitialEvaluationVerificationDetail']['verification_date'],'%d-%m-%Y','');
                                        echo $this->Form->input("$rc.verification_date", array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                                    ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.reason_if_not_approved",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleInitialEvaluationVerificationDetail']['reason_if_not_approved'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.verification_comment",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleInitialEvaluationVerificationDetail']['verification_comment'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
