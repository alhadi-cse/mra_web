<div id="frmStatus_add">
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LookupAffiliationType'); ?>
        <div class="form">           
            <table cellpadding="0" cellspacing="0" border="0">                
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td><?php echo $this->Form->input('affiliation_types',array('label'=>false)); ?></td>
                </tr>         
            </table>
        </div>        
       <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupAffiliationTypes','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
