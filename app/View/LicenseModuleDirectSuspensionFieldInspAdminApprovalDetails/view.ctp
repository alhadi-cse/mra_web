            ...
            <fieldset>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td><?php echo date("d-m-Y", strtotime($value['LicenseModuleDirectSuspensionFieldInspectorDetail']['inspection_date'])); ?></td>
                        <td><?php echo $this->Js->link('Approval Cancel', array('controller' => 'LicenseModuleDirectSuspensionFieldInspAdminApprovalDetailss', 'action' => 'approve_cancel', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class'=>'btnlink', 'confirm'=>'Are you sure to Cancel Approval ?', 'title'=>'Administrative Approval Cancel'))); ?></td>
                    </tr>
                  <?php } ?>
                </table>
