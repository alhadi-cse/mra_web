                        ...
                        <table class="view">
                            <tr>
                                ...
                                if(!$this->Paginator->param('options'))
                                    echo "<th style='min-width:150px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.full_name_of_org', 'Name of Organization', array('class'=>'asc')) . "</th>";
                                else 
                            ...
                            <tr>
                                ...
                                <td style="height:30px; padding:2px; text-align:center;"> 
                                    <?php 
                                        echo $this->Js->link('Pre. Details', array('controller' => 'LicenseModuleRecommendationOfEvaluationCommittees','action' => 'preview', $orgDetail['BasicModuleBasicInformation']['id']), 
