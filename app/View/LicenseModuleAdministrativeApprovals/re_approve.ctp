        ...
        <div class="form">
            <table cellpadding="8" cellspacing="8" border="0">                
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td>
                        <?php echo $this->Form->input("approval_status_id", array('type' => 'radio', 'class' => 'approval_status', 'options' => $approval_status_options, 'default' => $approvalDetails['LicenseModuleAdministrativeApproval']['approval_status_id'], 'legend' => false, 'div' => false)); ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-left:10px">
                        <?php 
                            echo $this->Time->format($approvalDetails['LicenseModuleAdministrativeApproval']['approval_date'],'%d-%m-%Y','');
                            echo $this->Form->input('approval_date', array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                        ?>
                    </td>
                </tr>
                <tr id="if_not_approved">
                    <td>Reason (if not approved)</td>
                    <td class="colons">:</td>
                    <td style="padding-left:10px">
                        <?php 
                            echo $this->Form->input('reason_if_not_approved',array('type' => 'textarea', 'value'=>$approvalDetails['LicenseModuleAdministrativeApproval']['reason_if_not_approved'], 'escape' => false, 'div'=>false,'label' => false)); 
                        ?>
                    </td>
                </tr>
                <tr>
                    <td>Comment</td>
                    <td class="colons">:</td>
                    <td style="padding-left:10px"><?php echo $this->Form->input('comment',array('type' => 'textarea', 'value'=>$approvalDetails['LicenseModuleAdministrativeApproval']['comment'], 'escape' => false, 'div'=>false, 'label' => false)); ?></td>
                </tr>
            </table>
        </div>
        <div class="btns-div"> 
