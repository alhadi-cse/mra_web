...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleAdministrativeApproval'); ?>
            ...
            <table style="width:100%;" cellpadding="8" cellspacing="8" border="0">
                <tr>
                    ...
                    <?php 
                        ...
                        echo $this->Js->link('Recommendation Details', array('controller'=>'LicenseModuleRecommendationOfEvaluationCommittees','action'=>'preview', $org_id), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block;', 'update'=>'#popup_div')));
                    ?>
                    </td>
                </tr>
                <tr>
