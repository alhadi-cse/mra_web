...
<div>
    ...
    <fieldset>
        ...
        <div class="form">
            ...
            <?php
            if (empty($org_id)) {
                echo $this->Form->create('LicenseModuleFieldInspectorApprovalSearch');
                ?>
            ...
            <fieldset style="margin-top:7px;">
                ...
                if (empty($values_approved) || !is_array($values_approved) || count($values_approved) < 1) {
                    ...
                    <table class="view">
                        ...
                        <?php foreach ($values_approved as $value) { ?>
                            <tr>
                                ...
                                <td><?php echo $this->Js->link('Approval Cancel', array('controller' => 'LicenseModuleFieldInspectorApprovalDetails', 'action' => 'approve_cancel', $value['BasicModuleBasicInformation']['id'], $inspection_type_id), array_merge($pageLoading, array('class' => 'btnlink', 'confirm' => 'Are you sure to Cancel Approval ?', 'title' => "$approvalType Approval Cancel"))); ?></td>
                            </tr>
                        <?php } ?>
                    </table>
                    ...
                    if (count($values_approved) > 1) {
                        ...
                        . $this->Js->link('Update All', array('controller' => 'LicenseModuleFieldInspectorApprovalDetails', 'action' => 'approve_edit_all', $inspection_type_id, $licensed_mfi), array_merge($pageLoading, array('class' => 'mybtns', 'title' => 'Edit Approval of All Assigned Inspector')))
                        . '</div>';
                    }
                    ?>
                ...
                if (empty($values_not_approved) || !is_array($values_not_approved) || count($values_not_approved) < 1) {
                    ...
                    <table class="view">
                        <tr>
                            ...
                            echo "<th style='width:150px;'>" . $this->Paginator->sort('0.inspectors_name_with_designation_and_dept', 'Inspectors Name & Designation') . "</th>";
                            echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleFieldInspectionInspectorDetail.inspection_date', 'Inspection Date') . "</th>";
                            echo "<th style='width:80px;'>" . $this->Paginator->sort('LookupLicenseAdminApprovalStatus.approval_admin_level', 'Approve Level') . "</th>";
                            echo "<th style='width:75px;'>Action</th>";
                            ?>
                        </tr>
                        <?php foreach ($values_not_approved as $value) { ?>
                            <tr>
                                ...
                                <td><?php echo $value[0]['inspectors_name_with_designation_and_dept']; ?></td>
                                <td><?php echo date("d-m-Y", strtotime($value['LicenseModuleFieldInspectionInspectorDetail']['inspection_date'])); ?></td>
                                <td><?php echo $value['LookupLicenseAdminApprovalStatus']['approval_admin_level']; ?></td>
                                <td style="height:30px; padding:2px; text-align:center;"> 
                                    <?php
                                    echo $this->Js->link('Approve', array('controller' => 'LicenseModuleFieldInspectorApprovalDetails', 'action' => 'approve', $value['BasicModuleBasicInformation']['id'], $inspection_type_id), array_merge($pageLoading, array('class' => 'btnlink', 'confirm' => 'Are you sure to approve this Inspector assignment ?', 'title' => 'Approval for this Inspector Assign')))
                                    . $this->Js->link('Cancel', array('controller' => 'LicenseModuleFieldInspectorApprovalDetails', 'action' => 'cancel', $value['BasicModuleBasicInformation']['id'], $inspection_type_id), array_merge($pageLoading, array('class' => 'btnlink', 'confirm' => 'Are you sure to Cancel this Inspector assignment ?', 'title' => 'Inspector Assignment Cancel')));
                    ...
                    if (count($values_not_approved) > 1) {
                        echo '<div class="btns-div" style="padding:7px; text-align:center;">'
                        . $this->Js->link('Approve All', array('controller' => 'LicenseModuleFieldInspectorApprovalDetails', 'action' => 'approve_all', $inspection_type_id, $licensed_mfi), array_merge($pageLoading, array('class' => 'mybtns', 'title' => 'Approval for All Assigned Inspector')))
                        . '</div>';
                    }
                }
                ?>
