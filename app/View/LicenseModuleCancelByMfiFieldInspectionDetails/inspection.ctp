...
<div>
    ...
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleCancelByMfiFieldInspectionDetail'); ?>
        ...
        <div class="form">
            <p style="border-bottom: 2px solid #137387; padding:0 0 0 15px;">
                ...
                echo $this->Js->link('Assess Details', array('controller' => 'LicenseModuleInitialAssessmentDetails', 'action' => 'preview', $org_id), 
            ...
            <fieldset>
                ...
                <table cellpadding="3" cellspacing="3" border="0" style="width:85%;">
                    <tr>
                        ...
                        <td style="width:70%;">
                            <?php 
                            echo $this->Form->input("inspection_date", array('type' => 'hidden', 'id' => 'txtInspectionDate_alt', 'label' => false))
                ...
                <table cellpadding="3" cellspacing="3" border="0" style="width:85%;">
                    <tr>
                        ...
                        <td style="width:60%; font-weight:bold;">
                            ...
                            echo $this->Form->input("is_approved", array('type' => 'hidden', 'value' => '-1', 'label' => false));
                            ?>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleCancelByMfiFieldInspectionDetails','action' => 'view'), array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
