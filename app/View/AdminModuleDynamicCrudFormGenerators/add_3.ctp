...
//                                                    $colon_style = "style='width:5px; padding:10px 0; font-weight:bold; vertical-align:top;'";
                                                ...
                                                case 'dependent_dropdown':
                                                    //$input_control = "<div id='control_id_to_be_updated1'>Test</div>";                                                    
                                                ...
                                                case 'date_range':
                                                    ...
                                                    $input_control = $this->Form->input('', array('type' => 'text', 'id' => $field_name, 'value' => $period, 'disabled' => 'disabled', 'label' => false)) .
                                            ...
                                            <tr <?php echo $tr_style; ?>>
                                                ...
                                                if ($has_slno) {
                                                    ++$sl_no;
                                                    echo "<td style='width:25px; padding:10px 0 0 0; vertical-align:top; text-align:center; font-weight:bold;'>";
                                                    echo $sl_no < 10 ? "0$sl_no." : "$sl_no.";
                                                    echo "</td>";

                                                    $field_label_style = " style='width:244px; padding:10px 0 0 0; vertical-align:top;'";
                                                } else if ($sl_alph) {
                                                    echo "<td style='width:25px; padding:10px 3px 0 7px; vertical-align:top; text-align:right; font-weight:bold;'>";
                                                    if ($all_num_sl_no) {
                                                        ++$sl_no;
                                                        echo $sl_no < 10 ? "0$sl_no." : "$sl_no.";
                                                    } else if ($sl_alph) {
                                                    ...
                                                    $field_label_style = " style='width:230px; padding:10px 0 0 0; vertical-align:top;'";
                                                } else {
                                                    $field_label_style = " colspan='2' style='width:250px; padding:10px 0 0 0; vertical-align:top;'";
                                                }
                                                ?>
                                                <td <?php echo $field_label_style; ?>><?php echo $field_label; ?></td>
                                                <td style="width:5px; padding:10px 0; font-weight:bold; vertical-align:top;"><?php echo $colon; ?></td>
                                                <td style="min-width:140px; vertical-align:top;"><?php echo $input_control; ?></td>
                                                <?php
//                                                    if ($has_notes) {
...
//                                                    }
                                                if ($has_notes) {
                                                    ?>
                                                    <td style="min-width:85px; vertical-align:top;">
                                                        <?php
                                                        $noteLoading = array('id' => "btnNote_$field_id", 'update' => '#note_content', 'class' => 'my-btns sbtns', 'style' => 'width:60px; margin-left:8px;', 'evalScripts' => true,
                                                            'title' => "Add or Edit Notes for '$field_label'.",
                                                            'before' => $this->Js->get('#busy-indicator')->effect('fadeIn', array('buffer' => false)),
