...
//                                                }
                                            ...
                                            switch ($control_type) {
                                                case 'calculated_label':
                                                    ...
                                                    $all_script .= "$('#sum_$field_id').val($str_sum);" .
                                                            "$('$str_ids').each(function() { " .
                                                            "$(this).keyup(function() { " .
                                            ...
                                            <tr <?php echo $tr_style; ?>>
                                                ...
                                                if ($has_slno) {
                                                    ...
                                                    $field_label_style = " style='width:273px; padding:10px 0; vertical-align:top;'";
                                                } else if ($sl_alph) {
                                                    ...
                                                    $field_label_style = " style='width:260px; padding:10px 0; vertical-align:top;'";
                                                } else {
                                                    $field_label_style = " colspan='2' style='width:285px; padding:10px 0; vertical-align:top;'";
                                                }
                                                ?>
                                                <td <?php echo $field_label_style; ?>><?php echo $field_label; ?></td>
                                                <td <?php echo $colon_style; ?>><?php echo $colon; ?></td>
                                                <td style="min-width:150px;"><?php echo $input_control; ?></td>
                                                <?php
                                                if ($has_notes) {
                                                    ?>
                                                    <td>
