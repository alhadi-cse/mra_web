...
//                                                                $this->Form->input($field_name, array('type' => 'hidden', 'value' => $field_value_from_session, 'label' => false));
//                                                    } else {
//                                                        $input_control = $this->Form->input($field_name, array('type' => 'select', 'options' => $options, 'id' => $control_id, 'empty' => '---Select---', 'label' => false));
//                                                    }
                                                    break;
                                                ...
                                                case 'date_range':
                                                    ...
                                                    $input_control = "<div><label id='$control_id' class='label_disabled'>$period</label></div>" //$this->Form->input('', array('type' => 'text', 'value' => $period, 'disabled' => 'disabled', 'label' => false))
