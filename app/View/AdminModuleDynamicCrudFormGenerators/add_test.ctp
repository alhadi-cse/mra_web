...
//                                            }
                                            ...
                                            switch ($control_type) {
                                                case 'aggregate_label':
                                                    $sumIdName = $field_name;
                                                    if (!empty($sub_group_id) && $sub_group_id == 999) {
                                                        $sumClassName = "input[class^=\"sum_classGroup_$group_id\"]";
                                                        $className = "sum_classGroup_$group_id";
                                                    ...
                                                    $input_control = $this->Form->input("Aggregate.$sumIdName", array('id' => $sumIdName, 'type' => 'text', 'class' => "readonly $className", 'style' => 'width:100px; text-align:right;', 'readonly' => 'readonly', 'label' => false));
                                                    //$input_control = $this->Form->input("Aggregate.$field_name", array('id' => $field_name, 'type' => 'text', 'class' => "readonly $className", 'style' => 'width:100px; text-align:right;', 'readonly' => 'readonly', 'label' => false));
                                                    break;
                                                ...
                                                case 'calculated_label':
                                                    ...
                                                    $tr_style = "style='font-weight:bold;'";
                                                    $input_control = $this->Form->input("Calculated.$field_name", array('id' => $field_name, 'type' => 'text', 'class' => 'readonly', 'style' => 'width:100px; text-align:right;', 'readonly' => 'readonly', 'label' => false));
...
<script>
    ...
    $(function () {
        ...
        var selectedVal = $("#usage_types option:selected").val();
