...
if (!empty($field_details_list)) {
    ...
    <fieldset>
        ...
        if (!isset($period_id) || !isset($period)) {
            $period_id = $period = "";
        ...
        if ($field_details_list[0]) {
            ...
            foreach ($basic_field_details_list as $field_id => $field_details) {
                ...
                switch ($control_type) {
                    ...
                    case 'date_range':
                        $input_control = "<div><label id='$control_id' class='label_disabled'>$period</label></div>"
                ...
                echo (($sl_no % 2 == 0) ? "<tr $tr_style>" : "<tr class='odd' $tr_style>")//"<tr $tr_style>"
...
//        debug($cat_group_list);
        ...
        echo $this->Form->input("FormInfo.cat_level", array('type' => 'hidden', 'value' => $cat_level, 'label' => false));
...
//                                    debug($rc1 + ":" + $rc2 + ":" + $rc3 + ":");
//                                    $rc3++;
//                                    $dr_sub_sub_controls .= ($rc3 % 2 == 0) ? "<tr>" : "<tr class='odd'>";
//                                }
                                    ...
                                    foreach ($field_list as $field_id => $field_details) {
                                        ...
                                        switch ($control_type) {
                                            ...
                                            case 'select_or_label':
                                                if (!empty($field_value_from_session)) {
                                                    $value = !empty($options[$field_value_from_session]) ? $options[$field_value_from_session] : '';
                                                    $dynamic_control = "<div><label id='$control_id' class='label_disabled'>$value</label></div>" //$this->Form->input('', array('type' => 'text', 'id' => $control_id, 'value' => $value, 'disabled' => 'disabled', 'label' => false)) .
                                            ...
                                            case 'date_range':
                                                $dynamic_control = "<div><label id='$control_id' class='label_disabled'>$period</label></div>"
...
//                            {
//                                $rc2++;
//                                $dr_sub_controls .= ($rc2 % 2 == 0) ? "<tr>" : "<tr class='odd'>";
//                            }
                            ...
                            foreach ($field_details_list as $group_id => $field_list) {
                                foreach ($field_list as $field_id => $field_details) {
                                    ...
                                    switch ($control_type) {
                                        ...
                                        case 'date_range':
                                            $dynamic_control = "<div><label id='$control_id' class='label_disabled'>$period</label></div>" //$this->Form->input('', array('type' => 'text', 'id' => $control_id, 'value' => $period, 'disabled' => 'disabled', 'label' => false))
                                                    . $this->Form->input($control_name, array('type' => 'hidden', 'id' => $control_id, 'value' => $period_id, 'label' => false));
                                            break;
...
//                    {
//                        $rc1++;
//                        $dr_cat_controls .= ($rc1 % 2 == 0) ? "<tr>" : "<tr class='odd'>";
//                    }
                        ...
                        foreach ($field_list as $field_id => $field_details) {
                            ...
                            switch ($control_type) {
                                ...
                                case 'select_or_label':
                                    if (!empty($field_value_from_session)) {
                                        $value = !empty($options[$field_value_from_session]) ? $options[$field_value_from_session] : '';
                                        $dynamic_control = "<div><label id='$control_id' class='label_disabled'>$value</label></div>"
                                                . $this->Form->input($control_name, array('type' => 'hidden', 'id' => $control_id, 'value' => $field_value_from_session, 'label' => false));
                                    } else {
                                        $dynamic_control = $this->Form->input($control_name, array('type' => 'select', 'options' => $options, 'id' => $control_id, 'empty' => '---Select---', 'label' => false));
                                    }
        ...
        if (!empty($dr_all_controls)) {
            ...
            //$all_script .= "$('#multi_tbl_view').fixedHeaderTable({altClass: 'odd', footer: false, cloneHeadToFoot: false, autoShow: true, fixedColumns: 1, autoResize: true});";
