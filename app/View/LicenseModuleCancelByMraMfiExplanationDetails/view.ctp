<?php
    if(!empty($msg)) {
        ...
        $title = "Explanation against Show cause";
...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleCancelByMraMfiExplanationDetail'); ?>
                            ...
                            <table class="view">
                                ...
                                <tr>
                                    ...
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleCancelByMraMfiExplanationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleCancelByMraMfiExplanationDetailPending');
                    ?>
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'LicenseModuleCancelByMraMfiExplanationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     

                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '187px';
                                        $actions = $actions.$this->Js->link('Give Explanation', array('controller'=>'LicenseModuleCancelByMraMfiExplanationDetails', 'action'=>'explanation_against_showcause', $value['BasicModuleBasicInformation']['id']), 
