            ...
            <fieldset>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleInitialAssessmentReviewVerificationDetail.verification_date', 'Verification Date') . "</th>";
                    ...
                    <?php foreach ($values_verified as $value) { ?>
                        <tr>
                            ...
                            <td style="font-weight:bold; text-align:center;">
                                ...
                                echo ($obtained_marks >= $pass_min_marks ? '<span style="color:#13af24;">' : ($obtained_marks >= $watchOut_min_marks ? '<span style="color:#faaf24;">' : '<span style="color:#fa2413;">'))
                            ...
                            <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleInitialAssessmentReviewVerificationDetail']['verification_date'], '%d-%m-%Y', ''); ?></td>
                            <td style="text-align:center; padding:2px; height:30px;">
                                <?php
                                //echo $this->Js->link('Re-Verify', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 're_verification', $value['LicenseModuleInitialAssessmentReviewVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));
                                echo $this->Js->link('Details', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'preview', $value['LicenseModuleInitialAssessmentReviewVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                                ?>     
                            </td>
                        </tr>
                    <?php } ?>
...
<!--                <div class="btns-div" style="padding:7px; text-align:center;">
                    <?php
                    //echo $this->Js->link('Update All', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'verification_edit_all'), array_merge($pageLoading, array('class' => 'mybtns', 'title' => 'Administrative Verification Update(From EVC)')));
                    ?>
                </div>-->
                <?php } ?>
            ...
            <fieldset>
                <legend>Initial Assessment Verification Not Approved</legend>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; padding:2px; height:30px;">
                            ...
                            if (!empty($user_is_committee_member)) 
                                echo $this->Js->link('Approve', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'verification_approval', $value['LicenseModuleInitialAssessmentReviewVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; padding:2px; height:30px;">
                            <?php
                            if (!empty($user_is_committee_member)) 
                                echo $this->Js->link('Re-Approve', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'verification_re_approval', $value['LicenseModuleInitialAssessmentReviewVerificationDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));
...
<!--                <div class="btns-div" style="padding:7px; text-align:center;">
            ...
            <fieldset>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php
                            echo $this->Js->link('Assess Details', array('controller' => 'LicenseModuleInitialAssessmentDetails', 'action' => 'preview', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                            ...
                            if (!empty($user_is_committee_member)) {
                                ...
                                echo $this->Js->link('Verification', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'verification', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                            }
                            ?>
                        </td>
                    </tr>
                ...
                if (count($values_pending) > 1 && !empty($user_is_committee_member)) {
                    ...
                    . $this->Js->link('Verify All', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'verification_all'), array_merge($pageLoading, array('class' => 'mybtns', 'title' => 'Initial Assessment Verify All')))
                    . '</div>';
                }
            }
            ?>
