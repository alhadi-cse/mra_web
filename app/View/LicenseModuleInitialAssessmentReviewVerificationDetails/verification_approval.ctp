...
<div>
    ...
    <fieldset>
        <legend>Initial Assessment Verification Approval</legend> 
        <?php echo $this->Form->create('LicenseModuleInitialAssessmentVerificationApprovalDetail'); ?>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    ...
                    <?php  echo $this->Js->link('Close', array('controller' => 'LicenseModuleInitialAssessmentReviewVerificationDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns'))); ?> 
                    </td>
