            ...
            <fieldset>
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleSuspensionReviewApplicationDetailPending');
                    ?>
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <td style='padding:2px; text-align:justify;'>
                                    <?php echo "<p style='background-color:#713002;color:#fff;'>Not yet applied</p>"; ?>
                                </td>
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'LicenseModuleSuspensionReliefDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     

                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '135px';
                                        $actions = $actions.$this->Js->link('Apply', array('controller'=>'LicenseModuleSuspensionReviewApplicationDetails', 'action'=>'apply', $value['BasicModuleBasicInformation']['id']), 
