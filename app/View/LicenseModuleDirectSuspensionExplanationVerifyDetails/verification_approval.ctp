...
$title = "License Verification of Explanation Against Suspension";
...
<div>
    ...
    <fieldset>
        <legend>License Verification of Explanation Against Suspension Approval</legend> 
        <?php echo $this->Form->create('LicenseModuleDirectSuspensionExplnVerifyApprovalDetail'); ?>
            ...
            <tr>
                <td colspan="3" style="border-bottom:2px solid #137387; padding:0;">
                    <p style="padding:0 0 0 15px;">
                        ...
                        echo $this->Js->link('Previous Details', array('controller' => 'LicenseModuleDirectSuspensionMfiExplanationDetails', 'action' => 'preview', $org_id), array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'display:inline-block;', 'update' => '#popup_div')));
                        ?>
                    </p>
                </td>
            </tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    ...
                    <?php  echo $this->Js->link('Close', array('controller' => 'LicenseModuleDirectSuspensionExplanationVerifyDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns'))); ?> 
                    </td>
