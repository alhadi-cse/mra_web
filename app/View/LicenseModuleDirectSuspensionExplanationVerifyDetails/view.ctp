...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if (empty($org_id)) {
                echo $this->Form->create('LicenseModuleDirectSuspensionExplanationVerifyDetail');
                ?>
            ...
            <fieldset>
                <legend>Verification of Explanation Against Suspension Completed</legend>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleDirectSuspensionExplanationVerifyDetail.verification_date', 'Verification Date') . "</th>";
                    ...
                    <?php foreach ($values_verified as $value) { ?>
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleDirectSuspensionExplanationVerifyDetail']['verification_date'], '%d-%m-%Y', ''); ?></td>
                            <td style="text-align:center; padding:2px; height:30px;">
                                <?php
                                    echo $this->Js->link('Details', array('controller' => 'LicenseModuleDirectSuspensionExplanationVerifyDetails', 'action' => 'preview', $value['LicenseModuleDirectSuspensionExplanationVerifyDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));
                                ?>     
                            </td>
                        </tr>
                    <?php } ?>
            ...
            <fieldset>
                <legend>Verification of Explanation Against Suspension Not Approved</legend>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; padding:2px; height:30px;">
                            ...
                            if (!empty($user_is_committee_member)) 
                                echo $this->Js->link('Approve', array('controller' => 'LicenseModuleDirectSuspensionExplanationVerifyDetails', 'action' => 'verification_approval', $value['LicenseModuleDirectSuspensionExplanationVerifyDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; padding:2px; height:30px;">
                            <?php
                            if (!empty($user_is_committee_member)) 
                                echo $this->Js->link('Re-Approve', array('controller' => 'LicenseModuleDirectSuspensionExplanationVerifyDetails', 'action' => 'verification_re_approval', $value['LicenseModuleDirectSuspensionExplanationVerifyDetail']['org_id']), array_merge($pageLoading, array('class' => 'btnlink')));                            
            ...
            <fieldset>
                <legend>Verification of Explanation Against Suspension Verification Pending</legend>
                <?php
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php                            
                            if (!empty($user_is_committee_member)) {
                                echo $this->Js->link('Verification', array('controller' => 'LicenseModuleDirectSuspensionExplanationVerifyDetails', 'action' => 'verification', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                            }
                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionExplanationVerifyDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
