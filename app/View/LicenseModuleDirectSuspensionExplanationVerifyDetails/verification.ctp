    ...
    <fieldset>
        ...
        <div class="form">
            <table style="width:100%;" cellpadding="8" cellspacing="8" border="0">
                ...
                <tr>
                    <td>Verification of Explanation Against Suspension Status</td>
                    <td class="colons">:</td>
                    <td>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleDirectSuspensionExplanationVerifyDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns'))); 
                       ?> 
                    </td>
                        ...
                        <?php
                            echo $this->Js->submit('Submit', array_merge($pageLoading, 
                                                    array('confirm' => "Are you sure to Submit ?", 
                                                          'success' => "msg.init('success', '$title', 'Explanation has been verified successfully.');",
