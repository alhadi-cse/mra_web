...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleDirectSuspensionAcceptanceOfReviewDetail'); ?>
            ...
            <fieldset>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:70px;'>" . $this->Paginator->sort('LicenseModuleDirectSuspensionAcceptanceOfReviewDetail.acceptance_date', 'Date') . "</th>";
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <?php 
                            if($value['LicenseModuleDirectSuspensionAcceptanceOfReviewDetail']['status_id']=='0'){
                                echo 'Review Rejected';
                            }
                            else if($value['LicenseModuleDirectSuspensionAcceptanceOfReviewDetail']['status_id']=='1'){
                                echo 'Review Accepted';
                            }                                
                            ?>
                        </td>                        
                        <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleDirectSuspensionAcceptanceOfReviewDetail']['acceptance_date'], '%d-%m-%Y', ''); ?></td>
                        <td style="text-align:center; padding:2px; height:30px;">
                           <?php 
                                echo $this->Js->link('Details', array('controller' => 'LicenseModuleDirectSuspensionAcceptanceOfReviewDetails', 'action' => 'preview', $value['LicenseModuleDirectSuspensionAcceptanceOfReviewDetail']['org_id']), 
                ...
                <div class="btns-div" style="padding:7px; text-align:center;">
                    <?php
                        echo $this->Js->link('Update All', array('controller' => 'LicenseModuleDirectSuspensionAcceptanceOfReviewDetails','action' => 'approve_edit_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Administrative Approval Update(From EVC)')));                            
                    ?>
                </div>                
                <?php } ?>
            </fieldset>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:justify;"> 
                            <?php 
                                echo $this->Js->link('Accept/Reject Review', array('controller'=>'LicenseModuleDirectSuspensionAcceptanceOfReviewDetails','action'=>'approve', $value['BasicModuleBasicInformation']['id']), 
                                                    array_merge($pageLoading, array('class'=>'btnlink')))
                                        . $this->Js->link('Details', array('controller' => 'LicenseModuleDirectSuspensionAcceptanceOfReviewDetails','action' => 'preview', $value['BasicModuleBasicInformation']['id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
                    </tr>
