                                ...
                                <td>
                                    <?php 
                                        $options = array('BasicModuleBranchInfo.branch_name'=>'Branch Name',
                                                         'LookupLoanActivitiesCategory.loan_activities_category' => 'Activity/Project');
                                ...
                                <td>
                                    <?php 
                                        if(!empty($opt_all) && $opt_all) {
                                            echo $this->Js->link('View All', array('controller'=>'LoanModuleLoanAcquisitionOnLoanSizes', 'action'=>'view', 'all'), 
                        ...
                        <div style="width:780px; height:auto; overflow-x:auto;">
                            ...
                            <table class="view">
                                <tr>
                                    ...
                                    <th style="width:100px;"><?php echo $this->Paginator->sort('LookupLoanSizePartitionOnDisburse.loan_size_partition_on_disbursed','Loan Size Partition on Loan Disbursed') ?></th>
                                    <th style="width:100px;"><?php echo $this->Paginator->sort('LookupLoanSizePartitionOnOutstanding.loan_size_partition_on_outstanding','Loan Size Partition on Loan Outstanding') ?></th>
                                    <th style="width:80px;"><?php echo $this->Paginator->sort('LoanModuleLoanAcquisitionOnLoanSize.year_and_month','Year & Month') ?></th> 
                                    <th style="width:80px;"><?php echo $this->Paginator->sort('LoanModuleLoanAcquisitionOnLoanSize.no_of_borrowers','No. Of Borrowers') ?></th>
                                    <th style="width:80px;"><?php echo $this->Paginator->sort('LoanModuleLoanAcquisitionOnLoanSize.total_loan_disbursed','Total Loan Disbursed') ?></th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $value['LookupLoanSizePartitionOnDisburse']['loan_size_partition_on_disbursed']; ?></td>
                                    <td><?php echo $value['LookupLoanSizePartitionOnOutstanding']['loan_size_partition_on_outstanding']; ?></td>
                                    <td style="text-align:center;"><?php echo $this->Time->format($value['LoanModuleLoanAcquisitionOnLoanSize']['year_and_month'], '%B, %Y', ''); ?></td>
                                    <td style="text-align:center;"><?php echo $value['LoanModuleLoanAcquisitionOnLoanSize']['no_of_borrowers']; ?></td>
                                    <td style="text-align:right;"><?php echo $value['LoanModuleLoanAcquisitionOnLoanSize']['amount_of_total_disbursed_loan_balance']; ?></td>
                                    <td style="height:30px; padding:2px; text-align:center;">
                                        <?php 
                                            echo $this->Js->link('Edit', array('controller'=>'LoanModuleLoanAcquisitionOnLoanSizes','action'=>'edit', $value['LoanModuleLoanAcquisitionOnLoanSize']['id'], $value['LoanModuleLoanAcquisitionOnLoanSize']['org_id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink')))
                                                .$this->Js->link('Details', array('controller'=>'LoanModuleLoanAcquisitionOnLoanSizes','action'=>'preview', $value['LoanModuleLoanAcquisitionOnLoanSize']['id']), 
...
//                                                    array_merge($pageLoading, array('class'=>'mybtns', 'success'=>'msc.prev();')));
                    ...
                    <td>
                        <?php 
                            echo $this->Js->link('Add New', array('controller'=>'LoanModuleLoanAcquisitionOnLoanSizes','action'=>'add'), 
