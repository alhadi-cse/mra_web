...
<div id="frmBasicInfo_add">
    <fieldset>
        ...
        <?php                 
            echo $this->Form->create('LicenseModuleCancelByMraShowcauseCancelNotifyDetail');
        ?>           
        <div class="form">            
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleCancelByMraShowcauseCancelNotifyDetails','action' => 'view?this_state_ids='.$this_state_ids),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
