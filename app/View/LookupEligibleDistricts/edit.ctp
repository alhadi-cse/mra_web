     ...
     <fieldset style="border:1px solid #9ebfe8">
        ...
        <div class="form">
            <table cellpadding="0" cellspacing="0" border="0">                
                ...
                <tr>
                    <td class="labelTd" style="width:200px;">Year</td>
                    <td class="colons">:</td>
       ...
       <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupEligibleDistricts','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
