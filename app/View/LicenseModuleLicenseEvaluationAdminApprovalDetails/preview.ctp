...
<div id="recEvalInfo" title="License Evaluation Information" style="margin:0px; padding:8px; background-color:#fafdff;">
    ...
    <div id="tabs">
        <ul>
          ...
          <li><a href="#tabs-6">Initial Evaluation Administrative Approval</a></li>
          <li><a href="#tabs-7">Field Inspection</a></li>
          <li><a href="#tabs-8">License Evaluation</a></li>
          <li><a href="#tabs-9">License Evaluation Administrative Approval</a></li>
        </ul>
        ...
        <div id="tabs-5">
            <?php echo $this->requestAction(array('controller'=>'LicenseModuleInitialEvaluationDetails', 'action'=>'approve_details', $org_id), array('return')); ?>
        </div>
        <div id="tabs-6">
            <?php echo $this->requestAction(array('controller'=>'LicenseModuleInitialEvaluationAdminApprovalDetails', 'action'=>'approve_details', $org_id), array('return')); ?>
        </div>
        <div id="tabs-7">
            <?php echo $this->requestAction(array('controller'=>'LicenseModuleFieldInspectionDetails', 'action'=>'inspection_details', $org_id, 1), array('return')); ?>    
        </div>
        <div id="tabs-8">
            <?php echo $this->requestAction(array('controller'=>'LicenseModuleLicenseEvaluationDetails', 'action'=>'approve_details', $org_id), array('return')); ?>
        </div>
        <div id="tabs-9">
            <?php echo $this->requestAction(array('controller'=>'LicenseModuleLicenseEvaluationAdminApprovalDetails', 'action'=>'approve_details', $org_id), array('return')); ?>
        </div>
    </div>
