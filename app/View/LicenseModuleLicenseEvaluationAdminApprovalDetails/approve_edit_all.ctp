<?php
    $title = 'Administrative Approval of License Evaluation';
...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleLicenseEvaluationAdminApprovalDetailAll'); ?>
                    ...
                    <div style="width:780px; height:auto; padding:0; overflow-x:auto;">
                        <?php 
                            if($orgDetails==null || !is_array($orgDetails) || count($orgDetails)<1) {
                                ...
                                echo $this->Js->link('Back', array('controller' => 'LicenseModuleLicenseEvaluationAdminApprovalDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));
                            }
                            else {
                        ?>
                            ...
                            <tr>
                                <td style="text-align:center;">
                                    <?php 
                                        ...
                                        echo $this->Form->input("$rc.id", array('type'=>'hidden', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationAdminApprovalDetail']['id'], 'label'=>false));    
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($approval_status_options as $value => $text) {
                                            echo "<input type='radio' style='margin:2px;' name='data[LicenseModuleLicenseEvaluationAdminApprovalDetailAll][$rc][approval_status_id]' ";
                                            if($value==$orgDetail['LicenseModuleLicenseEvaluationAdminApprovalDetail']['approval_status_id']){ echo 'checked'; }
                                ...
                                <td>
                                    <?php 
                                        echo $this->Time->format($orgDetail['LicenseModuleLicenseEvaluationAdminApprovalDetail']['approval_date'],'%d-%m-%Y','');
                                        echo $this->Form->input("$rc.approval_date", array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                                    ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.reason_if_not_approved",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationAdminApprovalDetail']['reason_if_not_approved'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.comment",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationAdminApprovalDetail']['comment'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td style="height:30px; padding:2px; text-align:center;"> 
                                    <?php 
                                        echo $this->Js->link('Details', array('controller' => 'LicenseModuleLicenseEvaluationAdminApprovalDetails','action' => 'preview', $orgDetail['BasicModuleBasicInformation']['id']), 
        ...
        <div class="btns-div">                
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleLicenseEvaluationAdminApprovalDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
                    <td style="text-align: center;">
                        <?php                                               
