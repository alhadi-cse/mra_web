<?php     
    ...
    if (!empty($IsValidUser) && !empty($org_id)) {         
        $title = "Update Office Information";
            ...
            <div class="btns-div"> 
                <table style="margin:0 auto; padding:0;" cellspacing="5">
                    <tr>
                        <td></td>       
                        <td></td>
                        <td><?php echo $this->Js->link('Back to Office List', array('controller'=>'BasicModuleProposedBranchInfos', 'action'=>'view'), $pageLoading); ?></td>
                        <td><?php echo $this->Js->submit('Update & Next', $pageLoading);?></td>
                        <td></td>
                        <td></td>   
                    </tr>
                </table>
...
$this->Js->get('#districts')->event('change', 
    $this->Js->request(array(
        'controller'=>'BasicModuleProposedBranchInfos',
...
<script>
    $(document).ready(function () {
        ...
        selectedVal = $( "#office_types option:selected" ).val();
