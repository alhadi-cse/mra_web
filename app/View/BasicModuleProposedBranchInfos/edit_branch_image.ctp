            ...
            <div class="btns-div">                
                <table style="margin:0 auto; padding:0;" cellspacing="7">
                    <tr>
                        ...
                        <td></td>                        
                        <td>
                            <input type="button" class="mybtns" id="btnUpload" value="Upload & Next" style="display:none" />
                            <?php echo $this->Js->submit('Next', array_merge($pageLoading, array('id'=>'btnNext','success' => "msg.init('success', '$title', 'Only Branch Information Updated Successfully But No Picture is Updated!');",
