<div id="frmStatus_add">
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LookupLicensingStatus'); ?>
        <div class="form">           
            <table cellpadding="0" cellspacing="0" border="0">                
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td><?php echo $this->Form->input('licensing_status',array('label'=>false)); ?></td>
                </tr>           
            </table>
        </div>        
       <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupLicensingStatuses','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
