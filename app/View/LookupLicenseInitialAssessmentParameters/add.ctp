                    ...
                    <td colspan="3" id="dynamic_parameter_val">
                        <table cellpadding="0" cellspacing="0" border="0">            
                            ...
                            <tr>
                                ...
                                <td class="colons" style="padding-left: 20px;">:</td>
                                <td class="inputTd" style="padding-left: 3px;"><?php echo $this->Form->input("field_id", array('type' => 'select','options'=>'null','empty'=>'-----Select-----','id'=>'field_names','label' => false)); ?></td>
                            </tr>                                               
                            <tr>
                    ...
                    <td colspan="3" id="group_name_val">
                        <table cellpadding="0" cellspacing="0" border="0">                     
                            <tr>
                                ...
                                <td class="inputTd" style="padding-left: 1px;"><?php echo $this->Form->input("operation_group_field_id", array('type' => 'select','options'=>'null','empty'=>'-----Select-----','id'=>'group_names','label' => false)); ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
