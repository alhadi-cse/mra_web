<?php   
    $title = "MFI explanation against suspend order";
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            ...
                            echo $this->Form->input('explanation_giving_date', array('type'=>'hidden', 'label'=>false));
                        ?>
                    </td>
                </tr>                
                <tr>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleDirectSuspensionMfiExplanationDetails','action' => 'view?this_state_ids='.$this_state_ids),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
