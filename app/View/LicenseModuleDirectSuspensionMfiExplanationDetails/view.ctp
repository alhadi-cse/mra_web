<?php
    if(!empty($msg)) {
        ...
        $title = "Explanation against Suspend Order";
...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleDirectSuspensionMfiExplanationDetail'); ?>
            ...
            <fieldset>
                <legend>Explanation Given</legend>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        <?php
                                            ...
                                            if($licensing_state_id==$thisStateIds[1]){
                                                echo "<p style='background-color:#037108;color:#fff;'>Explanation Given</p>";
                                            }                                            
                                            else{
                                                echo "<p style='background-color:#713002;color:#fff;'>Not Yet Given Any Explanation</p>";
                                            }                                            
                                        ?>
                                    </td>
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionMfiExplanationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                <legend>Pending/Not Given Explanation</legend>
                <?php 
                ...
                ?>
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0 )) {
                        echo $this->Form->create('LicenseModuleDirectSuspensionMfiExplanationDetailPending');
                    ?>
                    ...
                    <?php if (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0) { ?>
                        ...
                        <table class="view">
                            ...
                            <tr>
                                ...
                                <?php
                                    $actions = $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionMfiExplanationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id'],1), 
                                                                    array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));                                                                     

                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '187px';
                                        $actions = $actions.$this->Js->link('Give Explanation', array('controller'=>'LicenseModuleDirectSuspensionMfiExplanationDetails', 'action'=>'explanation_against_showcause', $value['BasicModuleBasicInformation']['id']), 
