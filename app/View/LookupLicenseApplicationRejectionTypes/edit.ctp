        ...
        <div class="form">
            <table cellpadding="0" cellspacing="0" border="0"> 
                ...
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td><?php echo $this->Form->input('rejection_type', array('type' => 'text', 'label' => false)); ?></td>
                </tr>
            </table>
        </div>
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php
                        echo $this->Js->link('Close', array('controller' => 'LookupLicenseApplicationRejectionTypes', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns')));
                        ?> 
                    </td>
