                    ...
                    <table class="view">
                        <tr>
                            ...
                            if(!$this->Paginator->param('options'))
                                echo "<th style='width:70px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.form_serial_no', 'Form No.', array('class'=>'asc')) . "</th>";
                            else 
                        ...
                        <?php foreach ($values_assessed_passed as $value) { ?>
                        <tr>
