...
if (!empty($inspection_type_id) && !empty($inspection_type_detail[$inspection_type_id]))
    $title = "Edit Administrative Approval for Assigned Inspector ($inspection_type_detail[$inspection_type_id])";
else
    $title = 'Edit Administrative Approval for Assigned Inspector';
...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleFieldInspectorAdminApprovalDetailAll'); ?>
        ...
        <div class="btns-div">                
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php
                        echo $this->Js->link('Close', array('controller' => 'LicenseModuleFieldInspectorAdminApprovalDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns', 'confirm' => 'Are you sure to Close ?', 'title' => 'Back to Previous Page')));
                        ?> 
                    </td>
                    <td style="text-align: center;">
                        <?php
