...
if (!empty($IsValidUser)) {
    $title = "Other immovable property (Add)";
                ...
                <table style="margin:0 auto; padding:0;" cellspacing="5">
                    <tr>
                        ...
                        <td>
                            <?php
                            if (!$isNew) {
                                echo $this->Js->link('Next', array('controller' => 'BasicModuleNonCurrentAssets', 'action' => 'add'), array_merge($pageLoading, array('success' => 'msc.next();')));
                            }
                            ?>
                        </td>
                        <td></td>
