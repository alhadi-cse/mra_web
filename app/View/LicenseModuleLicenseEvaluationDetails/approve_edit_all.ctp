...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleLicenseEvaluationDetailAll'); ?>
                ...
                <td>
                    <div style="width:780px; height:auto; padding:0; overflow-x:auto;">
                        ...
                        if ($orgDetails == null || !is_array($orgDetails) || count($orgDetails) < 1) {
                            ...
                            echo $this->Js->link('Back', array('controller' => 'LicenseModuleLicenseEvaluationDetails', 'action' => 'view'), array_merge($pageLoading, array('class' => 'mybtns')));
                        } else {
                        ?>
                            ...
                            <tr>
                                <td>
                                    <?php 
                                        ...
                                        echo $this->Form->input("$rc.id", array('type'=>'hidden', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationDetail']['id'], 'label'=>false));    
                                ...
                                <td>
                                    ...
                                    <?php 
                                        ...
                                        foreach ($approval_status_options as $value => $text) {
                                            echo "<input type='radio' style='margin:2px;' name='data[LicenseModuleLicenseEvaluationDetailAll][$rc][approval_status_id]' ";
                                            if($value==$orgDetail['LicenseModuleLicenseEvaluationDetail']['approval_status_id']){ echo 'checked'; }
                                ...
                                <td>
                                    <?php 
                                        echo $this->Time->format($orgDetail['LicenseModuleLicenseEvaluationDetail']['approval_date'],'%d-%m-%Y','');
                                        echo $this->Form->input("$rc.approval_date", array('type'=>'hidden', 'value'=>date("Y-m-d"), 'label'=>false));
                                    ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.reason_if_not_approved",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationDetail']['reason_if_not_approved'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
                                <td>
                                    <?php echo $this->Form->input("$rc.comment",array('type'=>'text', 'value'=>$orgDetail['LicenseModuleLicenseEvaluationDetail']['comment'], 'style'=>'width:120px; padding:5px;', 'escape'=>false, 'div'=>false, 'label'=>false)); ?>
                                </td>
