...
<div id="recEvalInfo" title="License Evaluation Information" style="height:auto; margin:0px; padding:8px; background-color:#fafdff;">
    ...
    <div id="tabs">
        <ul>
          ...
          <li><a href="#tabs-7">License Evaluation</a></li>
        </ul>
