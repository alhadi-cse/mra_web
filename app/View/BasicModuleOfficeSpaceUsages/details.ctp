...
$title = 'Usage of Office Space Details';
                ...
                <?php if ($data_count == 1) { ?>
                    <table cellpadding="7" cellspacing="8" border="0" style="width:100%;">
                        <tr>
                            ...
                            <td style="min-width:375px">
                                ...
                                <span style="float:right;">
                                    ...
                                    if ($isEditable) {
                                        echo $this->Js->link('Edit', array('controller' => 'BasicModuleOfficeSpaceUsages',
                                            'action' => 'edit', $allDataDetails['BasicModuleOfficeSpaceUsage']['id'], $allDataDetails['BasicModuleOfficeSpaceUsage']['org_id'], 2), array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'margin:0; padding:4px;')));
                                    }
                                    ?>
                                </span>
                            </td>
                        ...
                        <tr>
                            <td>Usage Type</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['LookupBasicOfficeUsageType']['usage_type']; ?></td>
                        </tr>                
                        <tr>
                            <td>Holding No.</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleOfficeSpaceUsage']['holding_no']; ?></td>
                        </tr>
                        <tr>
                            <td>Khatiyan No.</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleOfficeSpaceUsage']['khatiyan_no']; ?></td>
                        </tr>
                        <tr>
                            <td>District</td>
                            <td class="colons">:</td>
                        ...
                        <tr>
                            ...
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleOfficeSpaceUsage']['duration_of_proposed_rent_agreement']; ?></td>
                        </tr>
                        <tr>
                            <td>Proposed Monthly Rent</td>
                            <td class="colons">:</td>
                            <td><?php echo $allDataDetails['BasicModuleOfficeSpaceUsage']['proposed_monthly_rent']; ?></td>
                        </tr>                        
                    </table>
                        ...
                        <table cellpadding="7" cellspacing="8" border="0" class="view">
                            ...
                            foreach ($allDataDetails as $addDetails) {
                                ...
                                ?>>
                                    ...
                                    <td><?php
                                        echo $this->Js->link('Edit', array('controller' => 'BasicModuleOfficeSpaceUsages',
                                            'action' => 'edit', $addDetails['BasicModuleOfficeSpaceUsage']['id'], $addDetails['BasicModuleOfficeSpaceUsage']['org_id'], 2), array_merge($pageLoading, array('class' => 'btnlink')));
                                        ?>
                                    </td>
                                </tr>
                    <?php } ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (empty($data_count) || $data_count === 0) {
                            echo $this->Js->link('Add New', array('controller' => 'BasicModuleOfficeSpaceUsages', 'action' => 'add'), $pageLoading);
                        } else {
                            echo $this->Js->link('Close', array('controller' => 'BasicModuleOfficeSpaceUsages', 'action' => 'view'), $pageLoading);
                        }
                        ?>
                    </td>
