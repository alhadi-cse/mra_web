...
<div>
    ...
    //                        echo $this->Js->link('Reject and Send Notification', array('controller' => 'LicenseModuleEvaluationDetailInfos','action' => 'reject_all', $next_state_id, $orgDetail['BasicModuleBasicInformation']['id']), 
            ...
            <div class="btns-div">
                <table style="margin:0 auto; padding:5px;" cellspacing="7">
                    <tr>
                        <td>
                            <?php 
                                //echo $this->Js->link('Close', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'reject_all', 4, 21, 50), array_merge($pageLoading, array('class'=>'mybtns')));  
                           ?> 
                        </td>
                        <td style="text-align:center;">
                            <?php                                               
        ...
        <div class="btns-div">
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                        //echo $this->Js->link('Application Rejection', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'reject_all', 4, 21, 50), array_merge($pageLoading, array('class' => 'mybtns', 'style' => 'margin:10px auto;')));
