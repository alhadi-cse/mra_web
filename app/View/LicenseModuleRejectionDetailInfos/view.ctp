...
<div>
    ...
    <?php
        if ((!empty($values_waiting_for_appealed) && is_array($values_waiting_for_appealed) && count($values_waiting_for_appealed) > 0) 
                || (!empty($values_evaluated_failed) && is_array($values_evaluated_failed) && count($values_evaluated_failed) > 0)
                || (!empty($values_not_approved_in_admin_approval) && is_array($values_not_approved_in_admin_approval) && count($values_not_approved_in_admin_approval))) {
            $hasAnyData = true;
    ?>
    <fieldset>
...
//                            echo $this->Js->link('Appeal', array('controller'=>'LicenseModuleRejectionDetailInfos', 'action'=>'appeal', $orgDetail['BasicModuleBasicInformation']['id'], 23), 
//                                                            array_merge($pageLoading, array('class'=>'btnlink', )));
                ...
                <tr>
                    ...
                    <td style="height:30px; padding:2px; text-align:center;">
                        <?php 
                            ...
                            if($isAdmin)
                                echo $this->Js->link('Reject and Notify', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'initial_rejection', $orgDetail['BasicModuleBasicInformation']['id'], 4, 21), array_merge($pageLoading, array('class' => 'btnlink')));
                        ?>
                    </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                    ...
                    <td style="height:30px; padding:2px; text-align:center;">
                        <?php 
                            ...
                            if($isAdmin)
                                echo $this->Js->link('Reject and Notify', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'initial_rejection', $orgDetail['BasicModuleBasicInformation']['id'], 9, 21), array_merge($pageLoading, array('class' => 'btnlink')));
                        ?>
                    </td>
                </tr>
                <?php } ?>
        ...
        if($isAdmin && $rc > 0)
            echo '<div  class="btns-div" style="text-align:center;">'
                    . $this->Js->link('Initial Reject and Notify All', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'initial_rejection_all', 4, 21), array_merge($pageLoading, array('class' => 'mybtns', 'style' => 'margin:7px auto;')))
                    . '</div>';
        ?>
    </fieldset>
    <?php } ?>
    ...
    <?php 
        if ((!empty($values_not_appealed) && is_array($values_not_appealed) && count($values_not_appealed) > 0) 
                || (!empty($values_appeal_but_failed) && is_array($values_appeal_but_failed) && count($values_appeal_but_failed) > 0)) {
            $hasAnyData = true;
    ?>
    <fieldset style="margin-top:15px;">
                ...
                <tr>
                    ...
                    <td style="height:30px; padding:2px; text-align:center;">
                        <?php 
                            ...
                            if($isAdmin)
                                echo $this->Js->link('Reject and Notify', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'final_rejection', $orgDetail['BasicModuleBasicInformation']['id'], 4, 21, 50), 
                                                            array_merge($pageLoading, array('class' => 'btnlink')));
                        ?>
                    </td>
                </tr>
                    ...
                    <td style="height:30px; padding:2px; text-align:center;">
                        <?php 
                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleEvaluationDetailInfos', 'action'=>'preview', $orgDetail['BasicModuleBasicInformation']['id']), 
                                                            array_merge($pageLoading, array('class'=>'btnlink', 'update'=>'#popup_div')));
                            if($isAdmin)
                                echo $this->Js->link('Reject and Notify', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'final_rejection', $orgDetail['BasicModuleBasicInformation']['id'], 4, 21, 50), array_merge($pageLoading, array('class' => 'btnlink')));
                        ?>
                    </td>
                </tr>
                <?php } ?>
        ...
        <?php
            if($isAdmin && $rc > 0) 
                echo  '<div  class="btns-div" style="text-align:center;">'
                    . $this->Js->link('Final Rejection and Notify All', array('controller' => 'LicenseModuleRejectionDetailInfos', 'action' => 'final_rejection_all', 4, 21, 50), array_merge($pageLoading, array('class' => 'mybtns', 'style' => 'margin:7px auto;')))
                    . '</div>';
        ?>
