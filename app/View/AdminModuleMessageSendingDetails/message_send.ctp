            ...
            <table style="margin:0 auto; padding:5px;" cellspacing="5">
                <tr>
                    ...
                    <td style="text-align:center;">
                        <?php 
                        echo $this->Js->submit(!empty($re_send) ? 'Re-Send' : 'Send', array_merge($pageLoading, array('success' => "msg.init('success', '$title', '$title has been added successfully.');",
