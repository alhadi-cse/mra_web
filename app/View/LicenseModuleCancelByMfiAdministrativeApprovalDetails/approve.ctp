...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleCancelByMfiAdministrativeApprovalDetail'); ?>
            ...
            <table style="width:100%;" cellpadding="8" cellspacing="8" border="0">
                <tr>
                    ...
                    <?php 
                        ...
                        echo $this->Js->link('Pre. Details', array('controller'=>'LicenseModuleCancelByMfiAdministrativeApprovalDetails','action'=>'preview', $org_id), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block; float:right;', 'update'=>'#popup_div')));
                    ?>
                    </td>
                </tr>
                <tr>
