        ...
        <div class="form">
            <table cellpadding="8" cellspacing="8" border="0">
                <tr>
                    ...
                    <td style="padding-left:10px">
                        <?php
                            ...
                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleCancelByMfiAdministrativeApprovalDetails','action'=>'preview', $org_id), array_merge($pageLoading, array('class'=>'btnlink', 'style'=>'display:inline-block; float:right;', 'update'=>'#popup_div')));
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        $approvalStatusId = $approvalDetails['LicenseModuleCancelByMfiAdministrativeApprovalDetail']['approval_status_id'];
                ...
                <tr>
                    ...
                    <td style="padding-left:10px">
                        <?php 
                            echo $this->Time->format($approvalDetails['LicenseModuleCancelByMfiAdministrativeApprovalDetail']['approval_date'],'%d-%m-%Y','');
                ...
                <tr id="if_not_approved" <?php if(!empty($approvalStatusId) && $approvalStatusId == 1) echo 'style="display:none;"'; ?>>
                    ...
                    <td style="padding-left:10px">
                        <?php 
                            echo $this->Form->input('reason_if_not_approved',array('type' => 'textarea', 'value'=>$approvalDetails['LicenseModuleCancelByMfiAdministrativeApprovalDetail']['reason_if_not_approved'], 'escape' => false, 'div'=>false,'label' => false)); 
                        ?>
                    </td>
                </tr>
                <tr>
                    <td>Comment</td>
                    <td class="colons">:</td>
                    <td style="padding-left:10px"><?php echo $this->Form->input('comment',array('type' => 'textarea', 'value'=>$approvalDetails['LicenseModuleCancelByMfiAdministrativeApprovalDetail']['comment'], 'escape' => false, 'div'=>false, 'label' => false)); ?></td>
                </tr>
            </table>
        </div>
        <div class="btns-div"> 
