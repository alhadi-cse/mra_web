...
?>
    ...
    <div>
        <fieldset>
            ...
            <div class="form">
                <table cellpadding="5" cellspacing="5" border="0" style="width:87%;">

                    <tr>
                        <td style="width:170px;">Form No.</td>
                        <td class="colons">:</td>
                        <td style="font-weight:bold;">
                            ...
                            echo $this->Js->link('Rejection Details', array('action' => 'rejection_history_preview', $org_id),
                                    array_merge($pageLoading, array('class' => 'btnlink', 'style' => 'display:inline-block;', 'update' => '#popup_div')));
                    ...
                    <tr>
                        ...
                        <td class="colons">:</td>
                        <td><?php echo $this->Form->input("rejection_type_id", array('type' => 'radio', 'class' => 'rejection_type', 'options' => $rejection_type_options, 'default' => $rejection_type_id, 'legend' => false, 'div' => false)); ?></td>
                    </tr>
                    <tr>
                        <td>Rejection Category</td>
                        <td class="colons">:</td>
                        <td><?php echo $this->Form->input('rejection_category_id', array('type' => 'select', 'options' => $rejection_category_options, 'id' => 'categories', 'empty' => '-----Select-----', 'label' => false, 'div' => false)); ?></td>
                    </tr>
                    <tr>
            ...
            <div class="btns-div">
                <table style="margin:0 auto; padding:0;" cellspacing="7">
                    <tr>
                        <td>
                            <?php
                            echo $this->Js->link('Close', array('controller' => $controller, 'action' => $action, '?' => $parameters), array_merge($pageLoading, array('class' => 'mybtns')));
                            ?> 
                        </td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("input:radio.rejection_type").click(function() {
...
<?php
    ...
    $this->Js->get('#categories')->event('change', $this->Js->request(
            array('controller' => 'LicenseModuleApplicationRejectionDetails', 'action' => 'selected_reasons'), 
