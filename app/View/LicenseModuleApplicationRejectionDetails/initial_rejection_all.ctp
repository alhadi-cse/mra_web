            ...
            <table class="view">
                <tr>
                    <?php
                        ...
                        echo "<th style='min-width:370px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.full_name_of_org', 'Name of Organization') . "</th>";
                    ...
                    <td style="text-align:center;">
                        <?php                                               
                            echo $this->Js->submit('Reject and Notify to selected MFI', array_merge($pageLoading, 
                                                    array('class'=>'mybtns', 'confirm'=>'Are you sure to Reject all the selected MFI ?', 
