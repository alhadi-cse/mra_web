...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleApplicationFinalReject'); ?>
            ...
            <table style="margin:0 auto; padding:0;" cellspacing="7">
                <tr>
                    ...
                    <td style="text-align:center;">
                        <?php                                               
                            echo $this->Js->submit('Reject and Notify to MFI', array_merge($pageLoading, 
                                                    array('class'=>'mybtns', 'confirm'=>'Are you sure to final reject this MFI ?', 
