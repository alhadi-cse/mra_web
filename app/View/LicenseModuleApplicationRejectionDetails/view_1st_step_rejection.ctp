...
<div>
    ...
    <?php
    if ((!empty($values_waiting_for_appealed) && is_array($values_waiting_for_appealed) && count($values_waiting_for_appealed) > 0) || (!empty($values_evaluated_failed) && is_array($values_evaluated_failed) && count($values_evaluated_failed) > 0)) {
        $hasAnyData = true;
    ?>
        <fieldset>
                    ...
                    <table class="view">
                        ...
                        <tr>
                            ...
                            <td style="font-weight:bold; text-align:center;">
                                ...
                                if ($obtained_marks >= $watchOut_min_marks)
                            ...
                            <td style="height:30px; padding:2px; text-align:center;">
                                ...
                                echo $this->Js->link('RejectA', array('controller' => 'LicenseModuleApplicationRejectionDetails', 'action' => 'rejection', $orgDetail['BasicModuleBasicInformation']['id'], 1, '7_48_50'), array_merge($pageLoading, array('class' => 'btnlink')));
                                
                                echo $this->Js->link('Details', array('controller' => 'LicenseModuleInitialAssessmentAdminApprovalDetails', 'action' => 'preview', $orgDetail['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink', 'update' => '#popup_div')));

                                if ($isAdmin)
                                    echo $this->Js->link('Reject and Notify', array('controller' => 'LicenseModuleApplicationRejectionDetails', 'action' => 'initial_rejection', $orgDetail['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                                ?>
                            </td>
                        </tr>
                        <?php } ?>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;">
                            ...
                            if ($isAdmin)
                                echo $this->Js->link('Reject and Notify', array('controller' => 'LicenseModuleApplicationRejectionDetails', 'action' => 'final_rejection', $orgDetail['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class' => 'btnlink')));
                            ?>
                        </td>
                    </tr>
                    <?php } ?>
