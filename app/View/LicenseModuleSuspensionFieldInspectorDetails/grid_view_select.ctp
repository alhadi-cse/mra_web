...
<table class="view">
    <tr>
        <?php
            ...
            echo "<th style='width:120px;'>" . $this->Paginator->sort('LookupLicenseInspectorList.license_no.', 'License No.') . "</th>";            
        ?>
    </tr>
   <?php foreach($org_list_values as $org_list_value){ ?>
    <tr> 
        <td style="text-align: justify;"><?php echo $org_list_value['org_name']; ?></td>
        <td style="text-align: center;"><?php echo $org_list_value['license_no']; ?></td>
