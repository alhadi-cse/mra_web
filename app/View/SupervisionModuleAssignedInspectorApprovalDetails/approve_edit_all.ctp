...
$title = "Edit $approvalType Approval for Assigned Inspector";
...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('SupervisionModuleFieldInspectorApprovalDetailAll'); ?>
                    ...
                    foreach ($values_approved as $value) {
                        ...
                        <tr>
                            <td style="text-align:center;">
                                <?php
                                echo $this->Form->input("$rc.supervision_basic_id", array('type' => 'hidden', 'value' => $value['SupervisionModuleFieldInspectionInspectorDetail']['supervision_basic_id'], 'label' => false));
