        ...
        <div class="form">
            <table cellpadding="0" cellspacing="0" border="0">              
                ...
                <tr>
                    <td>Category</td>
                    <td class="colons">:</td>                    
                    <td><?php echo $this->Form->input('reject_suspend_cancel_category_id',array('type'=>'select','options'=>$reject_suspend_cancel_category_options, 'id'=>'reject_suspend_cancel_categories','empty' => '---Select---', 'label' => false)); ?></td>
                </tr> 
                <tr>
                    <td>Reason</td>
                    <td class="colons">:</td>                    
                    <td><?php echo $this->Form->input('reject_suspend_cancel_reason_id',array('type'=>'select','options'=>$reject_suspend_cancel_reason_options, 'id'=>'reject_suspend_cancel_reasons','empty' => '---Select---', 'label' => false)); ?></td>
                </tr>
                <tr>
                    <td>Date</td>
                    <td class="colons">:</td>
