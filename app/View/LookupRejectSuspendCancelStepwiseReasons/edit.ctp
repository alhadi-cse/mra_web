        ...
        <div class="form">           
            <table cellpadding="0" cellspacing="0" border="0"> 
                ...
                <tr>
                    <td>Category</td>
                    <td class="colons">:</td>                    
                    <td><?php echo $this->Form->input('reject_suspend_cancel_category_id',array('type'=>'select','options'=>$reject_suspend_cancel_category_options, 'id'=>'categories','empty' => '-----Select-----', 'label' => false)); ?></td>
                </tr> 
                <tr>
                    <td>Serial no</td>
                    <td class="colons">:</td>
