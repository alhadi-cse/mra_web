<div id="frmStatus_add">
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LookupInfoType'); ?>
        <div class="form">           
            <table cellpadding="0" cellspacing="0" border="0">                
                ...
                <tr>
                    <td>Info Type</td>
                    <td class="colons">:</td>
                    <td><?php echo $this->Form->input('info_types',array('label'=>false)); ?></td>
                </tr>               
            </table>
        </div>        
       <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupInfoTypes','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
