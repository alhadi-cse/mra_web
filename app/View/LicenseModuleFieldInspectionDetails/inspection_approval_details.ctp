            ...
            if (empty($approvalDetails) || !is_array($approvalDetails) || count($approvalDetails) < 1) {
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleFieldInspectionApprovalDetail.submission_date', 'Date') . "</th>";
                        echo "<th style='width:230px;'>" . $this->Paginator->sort('LicenseModuleFieldInspectionApprovalDetail.inspection_comment', 'Comment') . "</th>";
                    ...
                    <?php foreach ($approvalDetails as $value) { ?>
                        <tr>
                            ...
                            <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleFieldInspectionApprovalDetail']['submission_date'], '%d-%m-%Y', ''); ?></td>
                            <td style="text-align:left;"><?php echo $value['LicenseModuleFieldInspectionApprovalDetail']['inspection_comment']; ?></td>
