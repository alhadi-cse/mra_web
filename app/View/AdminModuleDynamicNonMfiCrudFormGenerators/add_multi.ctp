        ...
        if ($field_details_list[0]) {
            ...
            foreach ($basic_field_details_list as $field_id => $field_details) {
                ...
                switch ($control_type) {
                    ...
                    case 'date_range':
                        $input_control = "<label id='$control_id' class='label_disabled'>$period</label>" 
                                    ...
                                    foreach ($field_list as $field_id => $field_details) {
                                        ...
                                        switch ($control_type) {
                                            ...
                                            case 'select_or_label':
                                                if (!empty($field_value_from_session)) {
                                                    $value = !empty($options[$field_value_from_session]) ? $options[$field_value_from_session] : '';
                                                    $dynamic_control = "<label id='$control_id' class='label_disabled'>$value</label>" //$this->Form->input('', array('type' => 'text', 'id' => $control_id, 'value' => $value, 'disabled' => 'disabled', 'label' => false))
                                            ...
                                            case 'date_range':
                                                $dynamic_control = "<label id='$control_id' class='label_disabled'>$period</label>"
                            ...
                            foreach ($field_details_list as $group_id => $field_list) {
                                foreach ($field_list as $field_id => $field_details) {
                                    ...
                                    switch ($control_type) {
                                        ...
                                        case 'date_range':
                                            $dynamic_control = "<label id='$control_id' class='label_disabled'>$period</label>" //$this->Form->input('', array('type' => 'text', 'id' => $control_id, 'value' => $period, 'disabled' => 'disabled', 'label' => false))
                                                    . $this->Form->input($control_name, array('type' => 'hidden', 'id' => $control_id, 'value' => $period_id, 'label' => false));
                                            break;
