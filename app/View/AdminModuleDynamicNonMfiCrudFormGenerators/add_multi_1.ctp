                        ...
                        if ($cat_level > 2 && !empty($cat_field_list[2]['options'])) {
                            ...
                            foreach ($sub_sub_cat_options as $sub_sub_cat_id => $sub_sub_cat_title) {
                                ...
                                if (!empty($dr_sub_sub_controls)) {
                                    $rc++;
                                    $dr_sub_sub_controls .= ($rc % 2 == 0) ? "<tr>" : "<tr class='odd'>";
                                }

                                $cat_controls = $sub_sub_cat_title //"<strong>$sub_sub_cat_title</strong>"
                            ...
                            if (!empty($dr_sub_controls)) {
                                $rc++;
                                $dr_sub_controls .= ($rc % 2 == 0) ? "<tr>" : "<tr class='odd'>";
                            }
                            ...
                            $cat_controls = $sub_cat_title  //"<strong>$sub_cat_title</strong>"
                                    . $this->Form->input("$control_cat_name.$cat_field_name", array('type' => 'hidden', 'value' => $cat_id, 'label' => false))
                                    . $this->Form->input("$control_cat_name.$sub_cat_field_name", array('type' => 'hidden', 'value' => $sub_cat_id, 'label' => false));
...
//                    $dr_all_controls .= $dr_cat_controls;
                    ...
                    $rc++;
                    $dr_cat_controls = ($rc % 2 == 0) ? "<tr>" : "<tr class='odd'>";
                    $cat_controls = $cat_title . $this->Form->input("$control_cat_name.$cat_field_name", array('type' => 'hidden', 'value' => $cat_id, 'label' => false));
...
//            $all_script .= "$('#multi_tbl_view').fixedHeaderTable({footer: true, cloneHeadToFoot: true, altClass: 'odd', autoShow: true});"
//                    . "$('.fht-thead .fht-table').css({marginRight: ($('.fht-tbody').hasScrollBar() ? $('.fht-tbody').getScrollBarWidth() : 0) + 'px'});";
        }
        ?>
