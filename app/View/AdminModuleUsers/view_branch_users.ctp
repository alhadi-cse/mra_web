            ...
            <?php if (!empty($values) && count($values) > 0) { ?>
                <div id="searching">
                    <table class="view">
                        <tr>
                            <?php
                            echo "<th style='width:100px;'>" . $this->Paginator->sort('AdminModuleUser.user_name', 'User ID') . "</th>";
                            echo "<th style='width:250px;'>" . $this->Paginator->sort('AdminModuleUserGroupDistribution.name_with_designation_and_division', 'Name & Designation') . "</th>";
                            echo "<th style='width:250px;'>" . $this->Paginator->sort('AdminModuleUserGroupDistribution.branch_with_address', 'Branch') . "</th>";
                            echo "<th style='width:100px;'>" . $this->Paginator->sort('AdminModuleUser.activation_status_id', 'Activation Status') . "</th>";
                        ...
                        foreach ($values as $value) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $value['AdminModuleUserGroupDistribution']['name_with_designation_and_division']; ?></td>
                                <td><?php echo $value['AdminModuleUserGroupDistribution']['branch_with_address']; ?></td>
                                ...
                                <td>
                                    ...
                                    $this->Js->link('Edit', array('controller' => 'AdminModuleUsers', 'action' => 'edit_branch_user', $value['AdminModuleUser']['id'], $value['AdminModuleUserProfile']['org_id'], $value['AdminModuleUserProfile']['branch_id']), array_merge($pageLoading, array('class' => 'btnlink'))) .
