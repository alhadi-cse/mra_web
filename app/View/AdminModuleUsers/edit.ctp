        ...
        <div class="form">
            <table style="width:80%; min-width:640px;" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="colons">:</td>
                    <td style="padding: 2px 5px; font-weight: bold;"><?php if(!empty($this->request->data)) echo $this->request->data['AdminModuleUserOrgType']['user_org_types']; ?></td>
                </tr>
                <tr>
                    <td style="width:175px;">User Group</td>
                    <td class="colons">:</td>
                    <td style="padding: 2px 5px; font-weight: bold;"><?php if(!empty($this->request->data)) echo $this->request->data['AdminModuleUserGroup']['group_name']; ?></td>
                </tr>
