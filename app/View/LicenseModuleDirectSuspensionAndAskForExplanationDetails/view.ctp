...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleDirectSuspensionAndAskForExplanationDetailCompleted'); ?>
                                    ...
                                    <td style='padding:2px; text-align:justify;'>
                                        <?php
                                            ...
                                            if($licensing_state_id==$thisStateIds[1]){
                                                echo "<p style='background-color:#037108;color:#fff;'>Suspend Order Sent & Asked for Explanation</p>";
                                            }                                            
                                            else{
                                                echo "<p style='background-color:#713002;color:#fff;'>Not yet sent any suspend order</p>";
                                            }                                            
                                        ?>
                                    </td>
                                    <td style="height:30px; padding:2px; text-align:justify;">
                                        <?php 
                                            echo $this->Js->link('Details', array('controller'=>'LicenseModuleDirectSuspensionAndAskForExplanationDetails', 'action'=>'preview', $value['BasicModuleBasicInformation']['id']), 
            ...
            <fieldset>
                ...
                ?>                    
                    ...
                    if ($isAdmin && (!empty($pending_values) && is_array($pending_values) && count($pending_values) > 0)) {
                        echo $this->Form->create('LicenseModuleDirectSuspensionAndAskForExplanationDetailPending');
                    ?>
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    if($thisStateIds[0]==$value['BasicModuleBasicInformation']['licensing_state_id']){
                                        $width = '260px';
                                        $actions = $actions.$this->Js->link('Suspend & Ask for Explanation', array('controller'=>'LicenseModuleDirectSuspensionAndAskForExplanationDetails', 'action'=>'ask_explanation_for_suspension', $value['BasicModuleBasicInformation']['id']), 
