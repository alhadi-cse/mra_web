...
<div>
    <fieldset>
        ...
        <?php echo $this->Form->create('LicenseModuleCancelByMraFieldInspAdminApprovalDetailAll'); ?>
        ...
        <div style="width:780px; height:auto; padding:0; overflow-x:auto;">
            ...
            <table class="view">
                <tr>
                    <?php
                    echo "<th style='width:70px;'>" . $this->Paginator->sort('BasicModuleBasicInformation.form_serial_no', 'Form Serial No.') . "</th>";
                    ...
                    echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleCancelByMraFieldInspAdminApprovalDetail.inspection_date', 'Inspection Date') . "</th>";
                ...
                <tr>
                    <td style="text-align:center;">
                        ...
                        echo $value['BasicModuleBasicInformation']['form_serial_no'];
                        ?>
                    </td>
                    <td>
                        <?php
                    ...
                    <td><?php echo date("d-m-Y", strtotime($value['LicenseModuleCancelByMraFieldInspAdminApprovalDetail']['inspection_date'])); ?></td>
        ...
        <div class="btns-div">                
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleCancelByMraFieldInspAdminApprovalDetails','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
                    <td style="text-align: center;">
                        <?php                                               
