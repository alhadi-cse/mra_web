                ...
                <table class="view">
                    <tr>
                        <?php 
                            ...
                            echo "<th style='width:80px;'>" . $this->Paginator->sort('LicenseModuleCancelByMraFieldInspectorDetail.inspection_date', 'Inspection Date') . "</th>";
                    ...
                    <tr>
                        ...
                        <td><?php echo date("d-m-Y", strtotime($value['LicenseModuleCancelByMraFieldInspectorDetail']['inspection_date'])); ?></td>
                        <td><?php echo $this->Js->link('Approval Cancel', array('controller' => 'LicenseModuleCancelByMraFieldInspAdminApprovalDetails', 'action' => 'approve_cancel', $value['BasicModuleBasicInformation']['id']), array_merge($pageLoading, array('class'=>'btnlink', 'confirm'=>'Are you sure to Cancel Approval ?', 'title'=>'Administrative Approval Cancel'))); ?></td>
                    </tr>
                  <?php } ?>
                </table>
                ...
                <?php                
                    if(count($values_approved) > 1 ) {
                        echo '<div class="btns-div" style="padding:7px; text-align:center;">'
                                . $this->Js->link('Update All', array('controller' => 'LicenseModuleCancelByMraFieldInspAdminApprovalDetails', 'action' => 'approve_edit_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Cancel Administrative Approval of All Assigned Inspector.')))
                            . '</div>';
                    }
                ?>
            ...
            <fieldset>
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;"> 
                            <?php 
                                echo $this->Js->link('Approve', array('controller' => 'LicenseModuleCancelByMraFieldInspAdminApprovalDetails', 'action' => 'approve', $value['BasicModuleBasicInformation']['id']), 
                ...
                <?php
                    if(count($values_not_approved) > 1 ) {
                        echo '<div class="btns-div" style="padding:7px; text-align:center;">'
                                . $this->Js->link('Approve All', array('controller' => 'LicenseModuleCancelByMraFieldInspAdminApprovalDetails','action' => 'approve_all'), array_merge($pageLoading, array('class'=>'mybtns', 'title'=>'Administrative Approval for All Assigned Inspector')))
                            . '</div>';
                    }
                }
                ?>
