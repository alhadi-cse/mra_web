...
<div>
    <fieldset>
        ...
        <?php 
            echo $this->Form->create('LicenseModuleInitialAssessmentVerification');
        ?>
        ...
        <div class="btns-div">
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php
                            echo $this->Js->link('Close', array('controller' => 'LicenseModuleInitialAssessmentVerifications','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));
                        ?>
                    </td>
