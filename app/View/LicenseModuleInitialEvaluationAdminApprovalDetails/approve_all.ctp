            ...
            <table class="view" style="min-width:920px;">
                ...
                <tr>
                    ...
                    <td style="height:30px; padding:2px; text-align:center;"> 
                        <?php 
                            echo $this->Js->link('Pre. Details', array('controller' => 'LicenseModuleInitialEvaluationVerificationDetails','action' => 'preview', $orgDetail['BasicModuleBasicInformation']['id']), 
