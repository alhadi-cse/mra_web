<div id="frmStatus_add">    
    ...
    <fieldset>
        ...
        <?php  echo $this->Form->create('LookupTypeOfOrganization'); ?>
        <div class="form">           
            <table cellpadding="0" cellspacing="0" border="0">                
                ...
                <tr>
                    <td>Type</td>
                    <td class="colons">:</td>
                    <td><?php echo $this->Form->input('type_of_organization',array('label'=>false)); ?></td>
                </tr>                
                <tr>
                   <td style="text-align: center;">
                        <?php  echo $this->Js->link('Close', array('controller' => 'LookupTypeOfOrganizations','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  ?>
                   </td>
        ...
        <div class="btns-div"> 
            <table style="margin:0 auto; padding:5px;" cellspacing="7">
                <tr>
                    <td>
                        <?php 
                            echo $this->Js->link('Close', array('controller' => 'LookupTypeOfOrganizations','action' => 'view'),array_merge($pageLoading, array('class'=>'mybtns')));  
                       ?> 
                    </td>
                    <td style="text-align: center;">
                        <?php                                               
