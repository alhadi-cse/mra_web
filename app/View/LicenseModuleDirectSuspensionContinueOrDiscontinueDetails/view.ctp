...
<div>
    <fieldset>
        ...
        <div class="form">
            ...
            <?php if(empty($org_id)) { 
                echo $this->Form->create('LicenseModuleDirectSuspensionContinueOrDiscontinueDetail'); ?>
            ...
            <fieldset>
                ...
                <table class="view">
                    <tr>
                        ...
                        echo "<th style='width:70px;'>" . $this->Paginator->sort('LicenseModuleDirectSuspensionContinueOrDiscontinueDetail.decision_date', 'Date') . "</th>";
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            <?php 
                            if($value['LicenseModuleDirectSuspensionContinueOrDiscontinueDetail']['status_id']=='0'){
                                echo 'Suspension Continued';
                            }
                            else if($value['LicenseModuleDirectSuspensionContinueOrDiscontinueDetail']['status_id']=='1'){
                                echo 'Suspension Discontinued';
                            }                                
                            ?>
                        </td>                        
                        <td style="text-align:center;"><?php echo $this->Time->format($value['LicenseModuleDirectSuspensionContinueOrDiscontinueDetail']['decision_date'], '%d-%m-%Y', ''); ?></td>
                        <td style="text-align:center; padding:2px; height:30px;">
                           <?php 
                                echo $this->Js->link('Details', array('controller' => 'LicenseModuleDirectSuspensionContinueOrDiscontinueDetails', 'action' => 'preview', $value['LicenseModuleDirectSuspensionContinueOrDiscontinueDetail']['org_id']), 
                ...
                <table class="view">
                    ...
                    <tr>
                        ...
                        <td style="height:30px; padding:2px; text-align:center;">
                            <?php
                                echo $this->Js->link('Continue/Discontinue Suspension', array('controller'=>'LicenseModuleDirectSuspensionContinueOrDiscontinueDetails','action'=>'approve', $value['BasicModuleBasicInformation']['id']), 
                                                    array_merge($pageLoading, array('class'=>'btnlink')))
                                        . $this->Js->link('Details', array('controller' => 'LicenseModuleDirectSuspensionContinueOrDiscontinueDetails','action' => 'preview', $value['BasicModuleBasicInformation']['id']), 
                                                                array_merge($pageLoading, array('class'=>'btnlink', 'update' => '#popup_div')));
                            ?>
                        </td>
                    </tr>
