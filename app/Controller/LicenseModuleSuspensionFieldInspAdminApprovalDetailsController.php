...
class LicenseModuleSuspensionFieldInspAdminApprovalDetailsController extends AppController {
    ...
    public function view() {
        ...
        $condition_not_approved = array('BasicModuleBasicInformation.licensing_year' => $current_year, 'BasicModuleBasicInformation.licensing_state_id' => $thisStateIds[0]);
        $condition_approved = array('BasicModuleBasicInformation.licensing_year' => $current_year, 'BasicModuleBasicInformation.licensing_state_id' => $thisStateIds[1]);
        ...
        $fields = array('BasicModuleBasicInformation.id', 'BasicModuleBasicInformation.license_no', 'BasicModuleBasicInformation.short_name_of_org', 'BasicModuleBasicInformation.full_name_of_org',
            'LicenseModuleSuspensionFieldInspectorDetail.inspection_date',
        ...
        $values_not_approved = $this->LicenseModuleSuspensionFieldInspectorDetail->find('all', array('fields' => $fields, 'conditions' => $condition_not_approved, 'group' => 'LicenseModuleSuspensionFieldInspectorDetail.org_id'));
        $values_approved = $this->LicenseModuleSuspensionFieldInspectorDetail->find('all', array('fields' => $fields, 'conditions' => $condition_approved, 'group' => 'LicenseModuleSuspensionFieldInspectorDetail.org_id'));
    ...
    public function approve_all() {
        ...
        if ($this->request->is('post')) {
            try {
                $newData = $this->request->data['LicenseModuleSuspensionFieldInspAdminApprovalDetailAll'];
                if (!empty($newData)) {
...
//                        $this->redirect(array('action' => 'approve_all'));
                        ...
                        $this->loadModel('LicenseModuleSuspensionFieldInspectorDetail');
                        $done = $this->LicenseModuleSuspensionFieldInspectorDetail->updateAll(array('LicenseModuleSuspensionFieldInspectorDetail.is_approved' => 1), array('LicenseModuleSuspensionFieldInspectorDetail.org_id' => $org_ids));
                        if ($done) {
            ...
            try {
                ...
                if (!empty($newData)) {
                    ...
                    if (!empty($org_ids)) {
                        ...
                        $this->loadModel('LicenseModuleSuspensionFieldInspectorDetail');
                        $done = $this->LicenseModuleSuspensionFieldInspectorDetail->updateAll(array('LicenseModuleSuspensionFieldInspectorDetail.is_approved' => 0), array('LicenseModuleSuspensionFieldInspectorDetail.org_id' => $org_ids));
                        if ($done) {
                            $this->loadModel('BasicModuleBasicInformation');
    ...
    public function approve($org_id = null) {
        ...
        $this->loadModel('LicenseModuleSuspensionFieldInspectorDetail');
        $done = $this->LicenseModuleSuspensionFieldInspectorDetail->updateAll(array('LicenseModuleSuspensionFieldInspectorDetail.is_approved' => 1), array('LicenseModuleSuspensionFieldInspectorDetail.org_id' => $org_id));
    ...
    public function approve_cancel($org_id = null) {
        ...
        $this->loadModel('LicenseModuleSuspensionFieldInspectorDetail');
        $done = $this->LicenseModuleSuspensionFieldInspectorDetail->updateAll(array('LicenseModuleSuspensionFieldInspectorDetail.is_approved' => 0), array('LicenseModuleSuspensionFieldInspectorDetail.org_id' => $org_id));
        if ($done) {
            $this->loadModel('BasicModuleBasicInformation');
    ...
    public function re_approve($org_id = null) {
        ...
        $approvalDetails = $this->LicenseModuleSuspensionFieldInspAdminApprovalDetail->find('first', array('conditions' => array('LicenseModuleSuspensionFieldInspAdminApprovalDetail.org_id' => $org_id)));
        ...
        if ($this->request->is(array('post', 'put'))) {
            $newData = $this->request->data['LicenseModuleSuspensionFieldInspAdminApprovalDetail'];
            if (!empty($newData)) {
                $this->LicenseModuleSuspensionFieldInspAdminApprovalDetail->id = $approvalDetails['LicenseModuleSuspensionFieldInspAdminApprovalDetail']['id'];
                if ($this->LicenseModuleSuspensionFieldInspAdminApprovalDetail->save($newData)) {
                    $this->redirect(array('action' => 'view'));
                }
            }
            return;
        ...
        $approval_status_options = $this->LicenseModuleSuspensionFieldInspAdminApprovalDetail->LookupLicenseApprovalStatus->find('list', array('fields' => array('LookupLicenseApprovalStatus.id', 'LookupLicenseApprovalStatus.approval_status')));
