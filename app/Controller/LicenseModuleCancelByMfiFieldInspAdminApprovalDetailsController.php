...
class LicenseModuleCancelByMfiFieldInspAdminApprovalDetailsController extends AppController {
    ...
    public function view() {
        ...
        $fields = array('BasicModuleBasicInformation.*',
            'LicenseModuleCancelByMfiFieldInspectorDetail.inspection_date',
        ...
        $values_not_approved = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('all', array('fields' => $fields, 'conditions' => $condition_not_approved, 'group' => 'LicenseModuleCancelByMfiFieldInspectorDetail.org_id'));
        $values_approved = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('all', array('fields' => $fields, 'conditions' => $condition_approved, 'group' => 'LicenseModuleCancelByMfiFieldInspectorDetail.org_id'));
    ...
    public function approve_all() {
        ...
        if ($this->request->is('post')) {
            try {
                $newData = $this->request->data['LicenseModuleCancelRequestFieldInspAdminApprovalDetailAll'];
                if (!empty($newData)) {
...
//                        $this->redirect(array('action' => 'approve_all'));
                        ...
                        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
                        $done = $this->LicenseModuleCancelByMfiFieldInspectorDetail->updateAll(array('LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 1), array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_ids));
                        if ($done) {
            ...
            try {
                ...
                if (!empty($newData)) {
                    ...
                    if (!empty($org_ids)) {
                        ...
                        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
                        $done = $this->LicenseModuleCancelByMfiFieldInspectorDetail->updateAll(array('LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 0), array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_ids));
                        if ($done) {
                            $this->loadModel('BasicModuleBasicInformation');
    ...
    public function approve($org_id = null) {
        ...
        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
        $done = $this->LicenseModuleCancelByMfiFieldInspectorDetail->updateAll(array('LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 1), array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id));
    ...
    public function approve_cancel($org_id = null) {
        ...
        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
        $done = $this->LicenseModuleCancelByMfiFieldInspectorDetail->updateAll(array('LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 0), array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id));
        if ($done) {
            $this->loadModel('BasicModuleBasicInformation');
    ...
    public function re_approve($org_id = null) {
        ...
        $approvalDetails = $this->LicenseModuleCancelRequestFieldInspAdminApprovalDetail->find('first', array('conditions' => array('LicenseModuleCancelRequestFieldInspAdminApprovalDetail.org_id' => $org_id)));
        ...
        if ($this->request->is(array('post', 'put'))) {
            $newData = $this->request->data['LicenseModuleCancelRequestFieldInspAdminApprovalDetail'];
            if (!empty($newData)) {
                $this->LicenseModuleCancelRequestFieldInspAdminApprovalDetail->id = $approvalDetails['LicenseModuleCancelRequestFieldInspAdminApprovalDetail']['id'];
                if ($this->LicenseModuleCancelRequestFieldInspAdminApprovalDetail->save($newData)) {
                    $this->redirect(array('action' => 'view'));
                }
            }
            return;
        ...
        $approval_status_options = $this->LicenseModuleCancelRequestFieldInspAdminApprovalDetail->LookupLicenseApprovalStatus->find('list', array('fields' => array('LookupLicenseApprovalStatus.id', 'LookupLicenseApprovalStatus.approval_status')));
