...
//        $org_list = $this->BasicModuleBranchInfo->BasicModuleBasicInformation->find('list', array('fields' => array('id', 'name_of_org'), 'recursive' => -1, 'group' => array('BasicModuleBranchInfo.org_id'), 'order' => 'name_of_org'));
    ...
    function get_loan_infoX($admin_code = null, $org_id = null, $model_name = null, $field_name = null, $cat_id = null, $cat_sub_id = null, $cat_sub_sub_id = null) {
...
//            $report_list = Hash::remove($report_list, '{n}.report_id');
    ...
    function get_all_info($admin_code = null, $org_id = null, $model_name = null, $field_name = null, $period_id = null, $branch_type_id = null, $cat_id = null, $cat_sub_id = null, $cat_sub_sub_id = null) {
        ...
        if ($model_name == 3) {
            $model_name = 'SavingsModuleBranchwiseSavingsInformation'; //savings_module_branchwise_savings_informations
        }
        ...
        $fields = $joins = $group_field_list = $group_field_list = $order_field_list = array();
        ...
        if (!empty($branch_type_id))
            ...
            if ($this->$model_name->hasField('office_type_id'))
                $conditions = array('BasicModuleBranchInfo.office_type_id' => 3);
        }
        ...
        foreach ($loanInfos as $loanInfo) {
            try {
                $loan_infos[] = array(
                    'geo_code' => $loanInfo[0]["__geo_code"],
                    'geo_name' => $loanInfo[0]["__geo_name"],
                    'data_value' => empty($loanInfo[0]["__data_value"]) ? 0 : $loanInfo[0]["__data_value"]
                );
            } catch (Exception $ex) {
    ...
    function get_all_infoX($admin_code = null, $org_id = null, $model_name = null, $field_name = null, $period_id = null, $cat_id = null, $cat_sub_id = null, $cat_sub_sub_id = null) {
...
//                $asso_model_list = $this->$model_name->getAssociated();
//                if (empty($asso_model_list['LookupAdminBoundaryUpazila'])) {
//                    $joins = array(
//                        array(
//                            'table' => 'lookup_admin_boundary_upazilas',
//                            'alias' => 'LookupAdminBoundaryUpazila',
