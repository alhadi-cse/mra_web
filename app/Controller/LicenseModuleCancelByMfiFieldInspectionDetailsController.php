...
class LicenseModuleCancelByMfiFieldInspectionDetailsController extends AppController {
    ...
    public function view($opt = 'all', $mode = null) {
        ...
        if (!empty($org_id)) {
            $condition = array_merge(array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $org_id), $condition);
        }

        if ($this->request->is('post')) {
            $option = $this->request->data['LicenseModuleCancelByMfiFieldInspectionDetail']['search_option'];
            $keyword = $this->request->data['LicenseModuleCancelByMfiFieldInspectionDetail']['search_keyword'];
        ...
        $condition2 = array('licensing_year' => $current_year, 'licensing_state_id' => $thisStateIds[1], 'LicenseModuleCancelByMfiFieldInspectionDetail.is_approved' => -1);
        $condition3 = array('licensing_year' => $current_year, 'licensing_state_id' => $thisStateIds[1], 'LicenseModuleCancelByMfiFieldInspectionDetail.is_approved' => 0);
        $condition4 = array('licensing_year' => $current_year, 'licensing_state_id' => $thisStateIds[2], 'LicenseModuleCancelByMfiFieldInspectionDetail.is_approved' => 1);

        if (in_array($inspector_group_id,$user_group_id)) {

            $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');

            $user_id = $this->Session->read('User.Id');
            $this_user_org_id_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'LicenseModuleCancelByMfiFieldInspectorDetail.org_id', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelByMfiFieldInspectorDetail.inspector_user_id' => $user_id, 'LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelByMfiFieldInspectorDetail.org_id'));
            ...
            $condition2 = array_merge($condition2, array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $this_user_org_id_list));
            $condition3 = array_merge($condition3, array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $this_user_org_id_list));
            ...
            if (!empty($approved_org_id_list))
                $condition3 = array_merge($condition3, array('NOT' => array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $approved_org_id_list)));
        }
        ...
        $this->LicenseModuleCancelByMfiFieldInspectionDetail->recursive = 0;
        $values_not_inspect = $this->LicenseModuleCancelByMfiFieldInspectionDetail->BasicModuleBasicInformation->find('all', array('fields' => $all_fields, 'conditions' => $condition1));

        $values_inspected_not_submit = $this->LicenseModuleCancelByMfiFieldInspectionDetail->find('all', array('conditions' => $condition2, 'group' => array('org_id'), 'limit' => 10, 'order' => array('license_no' => 'asc')));

        $values_inspected_not_approved = $this->LicenseModuleCancelByMfiFieldInspectionDetail->find('all', array('conditions' => $condition3, 'group' => array('org_id'), 'limit' => 10, 'order' => array('license_no' => 'asc')));

        $this->paginate = array('conditions' => $condition4, 'group' => array('org_id'), 'limit' => 10, 'order' => array('license_no' => 'asc'));
        $this->Paginator->settings = $this->paginate;
        $values_inspected = $this->Paginator->paginate('LicenseModuleCancelByMfiFieldInspectionDetail');
    ...
    public function inspection($org_id = null) {
        ...
        if ($this->request->is('post')) {
            try {
                $newData = $this->request->data['LicenseModuleCancelByMfiFieldInspectionDetail'];
                //debug($newData);
                //return;
                ...
                $this->LicenseModuleCancelByMfiFieldInspectionDetail->create();
                if ($this->LicenseModuleCancelByMfiFieldInspectionDetail->save($newData)) {
        ...
        $orgNameDetail = $this->LicenseModuleCancelByMfiFieldInspectionDetail->BasicModuleBasicInformation->find('first', array('fields' => array('BasicModuleBasicInformation.full_name_of_org', 'BasicModuleBasicInformation.short_name_of_org'), 'conditions' => array('BasicModuleBasicInformation.id' => $org_id)));
        ...
        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
        //$inspector_name_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id)));
        $inspector_name_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id, 'LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelByMfiFieldInspectorDetail.inspector_user_id'));
    ...
    public function re_inspection($org_id = null, $option = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            $this->LicenseModuleCancelByMfiFieldInspectionDetail->id = $posted_data['id'];
            $done = $this->LicenseModuleCancelByMfiFieldInspectionDetail->save($posted_data);
        ...
        $inspectionDetails = $this->LicenseModuleCancelByMfiFieldInspectionDetail->find('first', array('conditions' => array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $org_id, 'is_approved' => -1), 'order' => array('submission_date' => 'desc')));
    ...
    public function inspection_approval($org_id = null) {
            ...
            if (!empty($option)) {
                ...
                if ($option == 1) {
                    ...
                    if ($done) {
                        ...
                        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
                        $this->LicenseModuleCancelByMfiFieldInspectorDetail->recursive = 0;
                        $inspector_id_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'inspector_user_id', 'conditions' => array('org_id' => $org_id, 'is_approved' => 1), 'group' => 'inspector_user_id'));
                        ...
                        if ((!empty($approve_count) && $approve_count == count($inspector_id_list))) {
                            ...
                            $this->LicenseModuleCancelByMfiFieldInspectionDetail->updateAll(array('is_approved' => 1), array('org_id' => $org_id, 'is_approved' => 0));
                    ...
                    $done = $this->LicenseModuleCancelByMfiFieldInspectionDetail->updateAll(array('is_approved' => -1), array('org_id' => $org_id, 'is_approved' => 0));
                    ...
                    if ($done) {
                        ...
                        if ($done) {
                            $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
                            $inspector_email_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'AdminModuleUserProfile.email', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id, 'LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelByMfiFieldInspectorDetail.inspector_user_id'));
                            ...
                            if (!empty($inspector_email_list)) {
                                ...
                                try {
									...
									/* 
                                    $inspector_details = $this->LicenseModuleCancelByMfiFieldInspectorDetail->AdminModuleUserProfile->find('list', array('fields' => 'AdminModuleUserProfile.full_name_of_user', 'recursive' => 0, 'conditions' => array('AdminModuleUserProfile.user_id' => $this->Session->read('User.Id'))));
									...
									$inspector_name = $this->LicenseModuleCancelByMfiFieldInspectorDetail->AdminModuleUserProfile->field('AdminModuleUserProfile.full_name_of_user', array('AdminModuleUserProfile.user_id' => $this->Session->read('User.Id')));

                                    $orgDetails = $this->LicenseModuleCancelByMfiFieldInspectionDetail->BasicModuleBasicInformation->find('first', array('fields' => array('license_no', 'short_name_of_org', 'full_name_of_org'), 'conditions' => array('BasicModuleBasicInformation.id' => $org_id), 'recursive' => -1));
                                    if (!empty($orgDetails)) {
        ...
        $inspectionDetails = $this->LicenseModuleCancelByMfiFieldInspectionDetail->find('first', array('conditions' => array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $org_id, 'is_approved' => 0), 'order' => array('submission_date' => 'desc')));
    ...
    public function inspection_details($org_id = null) {
        ...
        if (!empty($org_id)) {
            ...
            $post = $this->LicenseModuleCancelByMfiFieldInspectionDetail->find('first', array('conditions' => array('LicenseModuleCancelByMfiFieldInspectionDetail.org_id' => $org_id), 'order' => array('submission_date' => 'desc')));
            if (!$this->request->data) {
    ...
    function inspector_select() {
        $this->layout = 'ajax';
        $org_id = $this->request->data['LicenseModuleCancelByMfiFieldInspectionDetail']['org_id'];
        $this->loadModel('LicenseModuleCancelByMfiFieldInspectorDetail');
        //$inspector_name_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id)));
        $inspector_name_list = $this->LicenseModuleCancelByMfiFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelByMfiFieldInspectorDetail.org_id' => $org_id, 'LicenseModuleCancelByMfiFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelByMfiFieldInspectorDetail.inspector_user_id'));
        $inspector_names = implode('<br />', $inspector_name_list);
