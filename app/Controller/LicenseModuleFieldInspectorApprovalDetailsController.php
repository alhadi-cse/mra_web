...
class LicenseModuleFieldInspectorApprovalDetailsController extends AppController {
    ...
    public function view($inspection_type_id = null, $licensed_mfi = null) {
        ...
        $parameter = array('inspection_type_id' => $inspection_type_id, 'this_state_ids' => $this_state_ids, 'committee_group_id' => $committee_group_id, 'licensed_mfi' => $licensed_mfi, 'approval_states' => $approval_states);
        $redirect_url = array('controller' => 'LicenseModuleFieldInspectorApprovalDetails', 'action' => 'view', '?' => $parameter);
        ...
        $condition_approved = array('BasicModuleBasicInformation.licensing_state_id' => $isAdminApproval ? $thisStateIds[2] : $thisStateIds[1],
            'LicenseModuleFieldInspectionInspectorDetail.inspection_type_id' => $inspection_type_id,
            'LicenseModuleFieldInspectionInspectorDetail.is_approved' => $approvalStates[1],
        ...
        $condition_not_approved = array('BasicModuleBasicInformation.licensing_state_id' => $thisStateIds[1],
            'LicenseModuleFieldInspectionInspectorDetail.inspection_type_id' => $inspection_type_id,
            "LicenseModuleFieldInspectionInspectorDetail.is_approved $operator" => $approvalStates[0],
            'LicenseModuleFieldInspectionInspectorDetail.is_completed' => 0);
        ...
        $this->set(compact('approvalType', 'inspection_type_id', 'inspection_type_detail', 'isAdminApproval', 'licensed_mfi', 'values_not_approved', 'values_approved'));
        return;
    }
    ...
    public function approve($org_id = null, $inspection_type_id = null) {
        ...
        $conditions = array('LicenseModuleFieldInspectionInspectorDetail.org_id' => $org_id,
            'LicenseModuleFieldInspectionInspectorDetail.inspection_type_id' => $inspection_type_id,
            'OR' => array('LicenseModuleFieldInspectionInspectorDetail.is_approved' => 0,'LicenseModuleFieldInspectionInspectorDetail.is_approved >=' => $approvalStates[0]),
            'LicenseModuleFieldInspectionInspectorDetail.is_completed' => 0);
        $done = $this->LicenseModuleFieldInspectionInspectorDetail->updateAll(array('LicenseModuleFieldInspectionInspectorDetail.is_approved' => $approvalStates[1]), $conditions);
        if ($done) {
            if ($isAdminApproval) {
                $this->loadModel('BasicModuleBasicInformation');
                $updated = $this->BasicModuleBasicInformation->updateAll(array('BasicModuleBasicInformation.licensing_state_id' => $thisStateIds[2]), array('BasicModuleBasicInformation.id' => $org_id));
    ...
    public function cancel($org_id = null, $inspection_type_id = null) {
        ...
        $conditions = array('LicenseModuleFieldInspectionInspectorDetail.org_id' => $org_id,
            'LicenseModuleFieldInspectionInspectorDetail.inspection_type_id' => $inspection_type_id,
            //'LicenseModuleFieldInspectionInspectorDetail.is_approved' => $approvalStates[0],
            'OR' => array('LicenseModuleFieldInspectionInspectorDetail.is_approved' => 0, 'LicenseModuleFieldInspectionInspectorDetail.is_approved >=' => $approvalStates[0]),
            'LicenseModuleFieldInspectionInspectorDetail.is_completed' => 0);
...
//            }
    ...
    public function approve_cancel($org_id = null, $inspection_type_id = null) {
        ...
        $conditions = array('LicenseModuleFieldInspectionInspectorDetail.org_id' => $org_id,
            ...
            'LicenseModuleFieldInspectionInspectorDetail.is_approved' => $approvalStates[1],
            'LicenseModuleFieldInspectionInspectorDetail.is_completed' => 0);
        //$done = $this->LicenseModuleFieldInspectionInspectorDetail->updateAll(array('OR' => array('LicenseModuleFieldInspectionInspectorDetail.is_approved' => 0, 'LicenseModuleFieldInspectionInspectorDetail.is_approved >=' => $approvalStates[0])), $conditions);
        
        $done = $this->LicenseModuleFieldInspectionInspectorDetail->updateAll(array('LicenseModuleFieldInspectionInspectorDetail.is_approved' => $approvalStates[0]), $conditions);
        if ($done) {
            if ($isAdminApproval) {
                $this->loadModel('BasicModuleBasicInformation');
    ...
    public function approve_all($inspection_type_id = null, $licensed_mfi = null) {
        ...
        $this->set(compact('approvalType', 'isAdminApproval', 'licensed_mfi'));

        if ($this->request->is('post')) {
            try {
                $newData = $this->request->data['LicenseModuleFieldInspectorApprovalDetailAll'];
                if (!empty($newData)) {
    ...
    public function re_approve($org_id = null, $inspection_type_id = null) {
        ...
        $approvalDetails = $this->LicenseModuleFieldInspectorApprovalDetail->find('first', array('conditions' => array('LicenseModuleFieldInspectorApprovalDetail.org_id' => $org_id)));
        ...
        if ($this->request->is(array('post', 'put'))) {
            $newData = $this->request->data['LicenseModuleFieldInspectorApprovalDetail'];
            if (!empty($newData)) {
                $this->LicenseModuleFieldInspectorApprovalDetail->id = $approvalDetails['LicenseModuleFieldInspectorApprovalDetail']['id'];
                if ($this->LicenseModuleFieldInspectorApprovalDetail->save($newData)) {
                    $redirect_url = $this->Session->read('Current.RedirectUrl');
                    if (empty($redirect_url))
                        $redirect_url = array('action' => 'view', $inspection_type_id);
                    $this->redirect($redirect_url);
        ...
        $approval_status_options = $this->LicenseModuleFieldInspectorApprovalDetail->LookupLicenseApprovalStatus->find('list', array('fields' => array('LookupLicenseApprovalStatus.id', 'LookupLicenseApprovalStatus.approval_status')));
