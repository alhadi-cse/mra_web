...
class LicenseModuleDirectSuspensionFieldInspectionDetailsController extends AppController {
    ...
    public function view($opt = 'all', $mode = null) {
        ...
        if (!empty($org_id)) {
            $condition = array_merge(array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $org_id), $condition);
        }

        if ($this->request->is('post')) {
            $option = $this->request->data['LicenseModuleDirectSuspensionFieldInspectionDetail']['search_option'];
            $keyword = $this->request->data['LicenseModuleDirectSuspensionFieldInspectionDetail']['search_keyword'];
        ...
        $condition2 = array('licensing_year' => $current_year, 'licensing_state_id' => $thisStateIds[1], 'LicenseModuleDirectSuspensionFieldInspectionDetail.is_approved' => -1);
        $condition3 = array('licensing_year' => $current_year, 'licensing_state_id' => $thisStateIds[1], 'LicenseModuleDirectSuspensionFieldInspectionDetail.is_approved' => 0);
        $condition4 = array('licensing_year' => $current_year, 'licensing_state_id' => $thisStateIds[2], 'LicenseModuleDirectSuspensionFieldInspectionDetail.is_approved' => 1);

        if (in_array($inspector_group_id,$user_group_id)) {

            $this->loadModel('LicenseModuleCancelRequestFieldInspectorDetail');

            $user_id = $this->Session->read('User.Id');
            $this_user_org_id_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'LicenseModuleCancelRequestFieldInspectorDetail.org_id', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelRequestFieldInspectorDetail.inspector_user_id' => $user_id, 'LicenseModuleCancelRequestFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelRequestFieldInspectorDetail.org_id'));
            ...
            $condition2 = array_merge($condition2, array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $this_user_org_id_list));
            $condition3 = array_merge($condition3, array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $this_user_org_id_list));
            ...
            if (!empty($approved_org_id_list))
                $condition3 = array_merge($condition3, array('NOT' => array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $approved_org_id_list)));
        }
        ...
        $this->LicenseModuleDirectSuspensionFieldInspectionDetail->recursive = 0;
        $values_not_inspect = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->BasicModuleBasicInformation->find('all', array('fields' => $all_fields, 'conditions' => $condition1));

        $values_inspected_not_submit = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->find('all', array('conditions' => $condition2, 'group' => array('org_id'), 'limit' => 10, 'order' => array('license_no' => 'asc')));

        $values_inspected_not_approved = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->find('all', array('conditions' => $condition3, 'group' => array('org_id'), 'limit' => 10, 'order' => array('license_no' => 'asc')));

        $this->paginate = array('conditions' => $condition4, 'group' => array('org_id'), 'limit' => 10, 'order' => array('license_no' => 'asc'));
        $this->Paginator->settings = $this->paginate;
        $values_inspected = $this->Paginator->paginate('LicenseModuleDirectSuspensionFieldInspectionDetail');
    ...
    public function inspection($org_id = null) {
        ...
        if ($this->request->is('post')) {
            try {
                $newData = $this->request->data['LicenseModuleDirectSuspensionFieldInspectionDetail'];
                //debug($newData);
                //return;
                ...
                $this->LicenseModuleDirectSuspensionFieldInspectionDetail->create();
                if ($this->LicenseModuleDirectSuspensionFieldInspectionDetail->save($newData)) {
        ...
        $orgNameDetail = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->BasicModuleBasicInformation->find('first', array('fields' => array('BasicModuleBasicInformation.full_name_of_org', 'BasicModuleBasicInformation.short_name_of_org'), 'conditions' => array('BasicModuleBasicInformation.id' => $org_id)));
        ...
        $this->loadModel('LicenseModuleCancelRequestFieldInspectorDetail');
        //$inspector_name_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelRequestFieldInspectorDetail.org_id' => $org_id)));
        $inspector_name_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelRequestFieldInspectorDetail.org_id' => $org_id, 'LicenseModuleCancelRequestFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelRequestFieldInspectorDetail.inspector_user_id'));
    ...
    public function re_inspection($org_id = null, $option = null) {
        ...
        if ($this->request->is(array('post', 'put'))) {
            ...
            $posted_data = $this->request->data['LicenseModuleDirectSuspensionFieldInspectionDetail'];
            if (empty($org_id))
                $org_id = $posted_data['org_id'];
            if (!empty($option) && $option == 1)
                $posted_data['is_approved'] = 0;

            $this->LicenseModuleDirectSuspensionFieldInspectionDetail->id = $posted_data['id'];
            $done = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->save($posted_data);
        ...
        $inspectionDetails = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->find('first', array('conditions' => array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $org_id, 'is_approved' => -1), 'order' => array('submission_date' => 'desc')));
    ...
    public function inspection_approval($org_id = null) {
            ...
            if (!empty($option)) {
                ...
                if ($option == 1) {
                    ...
                    if ($done) {
                        ...
                        $this->loadModel('LicenseModuleCancelRequestFieldInspectorDetail');
                        $this->LicenseModuleCancelRequestFieldInspectorDetail->recursive = 0;
                        $inspector_id_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'inspector_user_id', 'conditions' => array('org_id' => $org_id, 'is_approved' => 1), 'group' => 'inspector_user_id'));
                        ...
                        if ((!empty($approve_count) && $approve_count == count($inspector_id_list))) {
                            ...
                            $this->LicenseModuleDirectSuspensionFieldInspectionDetail->updateAll(array('is_approved' => 1), array('org_id' => $org_id, 'is_approved' => 0));
                    ...
                    $done = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->updateAll(array('is_approved' => -1), array('org_id' => $org_id, 'is_approved' => 0));
                    ...
                    if ($done) {
                        ...
                        if ($done) {
                            $this->loadModel('LicenseModuleCancelRequestFieldInspectorDetail');
                            $inspector_email_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'AdminModuleUserProfile.email', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelRequestFieldInspectorDetail.org_id' => $org_id, 'LicenseModuleCancelRequestFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelRequestFieldInspectorDetail.inspector_user_id'));
                            ...
                            if (!empty($inspector_email_list)) {
                                ...
                                try {
                                    ...
                                    /* $inspector_details = $this->LicenseModuleCancelRequestFieldInspectorDetail->AdminModuleUserProfile->find('list', array('fields' => 'AdminModuleUserProfile.full_name_of_user', 'recursive' => 0, 'conditions' => array('AdminModuleUserProfile.user_id' => $this->Session->read('User.Id'))));
									...
									$inspector_name = $this->LicenseModuleCancelRequestFieldInspectorDetail->AdminModuleUserProfile->field('AdminModuleUserProfile.full_name_of_user', array('AdminModuleUserProfile.user_id' => $this->Session->read('User.Id')));

                                    $orgDetails = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->BasicModuleBasicInformation->find('first', array('fields' => array('license_no', 'short_name_of_org', 'full_name_of_org'), 'conditions' => array('BasicModuleBasicInformation.id' => $org_id), 'recursive' => -1));
                                    if (!empty($orgDetails)) {
        ...
        $inspectionDetails = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->find('first', array('conditions' => array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $org_id, 'is_approved' => 0), 'order' => array('submission_date' => 'desc', 'LicenseModuleDirectSuspensionFieldInspectionDetail.id' => 'desc')));
    ...
    public function inspection_details($org_id = null) {
        ...
        if (!empty($org_id)) {
            ...
            $post = $this->LicenseModuleDirectSuspensionFieldInspectionDetail->find('first', array('conditions' => array('LicenseModuleDirectSuspensionFieldInspectionDetail.org_id' => $org_id), 'order' => array('submission_date' => 'desc', 'LicenseModuleDirectSuspensionFieldInspectionDetail.id' => 'desc')));
            if (!$this->request->data) {
    ...
    function inspector_select() {
        $this->layout = 'ajax';
        $org_id = $this->request->data['LicenseModuleDirectSuspensionFieldInspectionDetail']['org_id'];
        $this->loadModel('LicenseModuleCancelRequestFieldInspectorDetail');
        //$inspector_name_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelRequestFieldInspectorDetail.org_id' => $org_id)));
        $inspector_name_list = $this->LicenseModuleCancelRequestFieldInspectorDetail->find('list', array('fields' => 'name_with_designation_and_dept', 'recursive' => 0, 'conditions' => array('LicenseModuleCancelRequestFieldInspectorDetail.org_id' => $org_id, 'LicenseModuleCancelRequestFieldInspectorDetail.is_approved' => 1), 'group' => 'LicenseModuleCancelRequestFieldInspectorDetail.inspector_user_id'));
        $inspector_names = implode('<br />', $inspector_name_list);
    ...
    public function inspection_approval_details($org_id = null) {
        ...
        $approvalDetails = $this->LicenseModuleFieldInspectionApprovalDetail->find('all', array('conditions' => array('org_id' => $org_id), 'group' => 'inspector_user_id', 'order' => array('submission_date' => 'desc')));
