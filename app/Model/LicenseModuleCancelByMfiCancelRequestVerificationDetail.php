...
class LicenseModuleCancelByMfiCancelRequestVerificationDetail extends AppModel {
    public $belongsTo = array(
        'AdminModuleUserProfile' => array(
            'className' => 'AdminModuleUserProfile',
            'foreignKey' => false,
            'conditions' => 'AdminModuleUserProfile.user_id = LicenseModuleCancelByMfiCancelRequestVerificationDetail.verification_committee_user_id'
        ),
