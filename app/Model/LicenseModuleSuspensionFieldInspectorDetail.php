...
class LicenseModuleSuspensionFieldInspectorDetail extends AppModel {
    ...
    public $belongsTo = array(
        ...
        'AdminModuleUserProfile' => array(
            ...
            'foreignKey' => false,
            'conditions' => 'AdminModuleUserProfile.user_id = LicenseModuleSuspensionFieldInspectorDetail.inspector_user_id'            
        ),
