...
class LicenseModuleInitialEvaluationDetail extends AppModel {
    ...
    public $belongsTo = array(
        ...
        'LicenseModuleInitialAssessmentMark' => array(
            ...
            'foreignKey' => false,
            'conditions' => 'LicenseModuleInitialAssessmentMark.org_id = LicenseModuleInitialEvaluationDetail.org_id'
        )
    );
