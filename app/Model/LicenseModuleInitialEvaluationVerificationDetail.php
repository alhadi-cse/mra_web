...
class LicenseModuleInitialEvaluationVerificationDetail extends AppModel {

    public $belongsTo = array(
        'AdminModuleUserProfile' => array(
            'className' => 'AdminModuleUserProfile',
            'foreignKey' => false,
            'conditions' => 'AdminModuleUserProfile.user_id = LicenseModuleInitialEvaluationVerificationDetail.verification_committee_user_id'
        ),
        ...
        'LicenseModuleInitialAssessmentMark' => array(
            ...
            'foreignKey' => false,
            'conditions' => 'LicenseModuleInitialAssessmentMark.org_id = LicenseModuleInitialEvaluationVerificationDetail.org_id'
        )
    );
