...
//                $self.css({width: widthMinusScrollbar});
                ...
                {
                    $wrapper.closest('div').parent().css({maxWidth: $wrapper.closest('div').parent().parent().width()});
                ...
                $divHead.find('.fht-table').css({marginRight: settings.scrollbarOffset});
                //alert(($(this).innerWidth() - $(this).width()));
                //$divHead.find('.fht-table').css({marginRight: Math.max((($(this).innerWidth() - $(this).width()) / 2), settings.scrollbarOffset)});
                /*
                 * Check for footer
        ...
        var helpers = {
            ...
            _fixWidthWithCss: function ($obj, tableProps, fix_width) {
                if (settings.includePadding) {
                    $obj.each(function () {
                        $(this).css({width: fix_width == undefined ? $(this).width() + tableProps.border : fix_width + tableProps.border});
                    });
                } else {
                    $obj.each(function () {
                        $(this).css({width: fix_width == undefined ? $(this).parent().width() + tableProps.border : fix_width + tableProps.border});
                    });
                }
            },
            ...
            _setupClone: function ($obj, cellArray) {
                var $self = $obj,
                        ...
                        'thead tr > *' :
                        ($self.find('tfoot').length) ? 'tfoot tr > *' : 'tbody tr:first-child > *',
                        $cell;
